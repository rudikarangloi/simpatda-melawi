...
dhtmlXGridObject.prototype._key_events={k13_1_0:function(){this.editStop()},
 ...
 k_other:function(ev){if (this.editor)return false;if (!ev.ctrlKey && ev.keyCode>=40 && ev.keyCode < 91)if (this.cell){var c=this.cells4(this.cell);if (c.isDisabled()) return false;var t=c.getValue();c.setValue();this.editCell();if (this.editor)this.editor.val=t}}};
//v.1.5 build 80319
