...
class pajak_lainnya extends MY_Controller {
	...
	public function index() {
		...
		$pemilik = "";
		$perusahaan = "";
		$this->load->view('data/pajak_lainnya',$data);
	}
...
LEFT JOIN master_rekening c ON c.pajak = LEFT(a.npwpd_perusahaan,1) AND c.pajak_det = SUBSTRING(a.npwpd_perusahaan,9,2) WHERE a.status_aktip='Y' AND LEFT(a.npwpd_perusahaan,2)!='61' AND $cu");
	...
	public function data() {
		...
		tgl_diterima, no_karcis1, no_karcis2, jns_retribusi, sub_jns_retribusi, jml_bayar, author, petugas_penagih FROM sptrd order by no_sptrd DESC","id","id, no_sptrd, tahun, kriteria_htg, 
		jml_karcis, skpd_pengelola, tgl_diterima, no_karcis1, no_karcis2, jns_retribusi, sub_jns_retribusi, jml_bayar, author, petugas_penagih");	
	}
