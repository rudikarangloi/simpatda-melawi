...
class tegur_skpd4 extends MY_Controller {
	...
	public function index() {
		...
		$this->load->view('peneguran/tegur_skpd5',$data);
	}
...
INNER JOIN stpd ON stpd.npwpd = identitas_perusahaan.npwpd_perusahaan $qr","id","no_stpd, no_nota, npwpd, nama_perusahaan, alamat_perusahaan, tanggal_tempo,jumlah");
	...
	public function simpan(){
		$data = array (
			...
			'tgl_surat2' 			=> strtoupper($this->input->post('tgl2')),
			'tgl_surat3' 			=> strtoupper($this->input->post('tgl3')),
			...
			'tahun' 			=> date('Y'),
			'no_tegur_1' 			=> $this->input->post('teguran'),
			'no_tegur_2' 			=> $this->input->post('teguran2'),
		...
		if($this->input->post('id')==0){
			...
			$this->db->insert('surat_tegur4',$dataIns);
			
		} else {
			$tegur = $this->input->post('id');
			$dataUpd = array_merge($data,array('no_teguran' => $tegur, 'modified' => date('Y-m-d H:i:s')));
			$this->db->update('surat_tegur4', $dataUpd, array('id_surat_tegur' => $this->input->post('id')));
		}
		echo $tegur;
	}
	
	public function generateNo($thn=""){
		$sql = $this->db->query("select MAX(no_teguran) as max from surat_tegur4 where tahun = '".$thn."'")->row();
		$r = $sql->max;
		if($r==NULL){
			$no = '000000001';
		} else {
...
a.kecamatan, c.nama_kecamatan, a.kabupaten, a.telp, a.kodepos, b.npwpd_pemilik, b.nama_pemilik, b.alamat_pemilik, b.jalan AS jalan_p,
 b.rt AS rt_p, b.rw AS rw_p, b.email AS email_p, b.lokasi, b.desa_kel2, b.kecamatan AS kecamatan_p, b.kabupaten AS kabupaten_p, b.hp,
  ...
  IFNULL(c.id,'00') AS idx, e.auto AS idauto,SUBSTRING(a.npwpd_perusahaan,9,2) AS rek,d.pemilik_pimpinan,d.tunggakan, DATE_FORMAT(d.tgl_surat,'%d/%m/%Y') AS tgl, 
  DATE_FORMAT(d.tgl_surat2,'%d/%m/%Y') AS tgl2, d.no_tegur_1, d.no_tegur_2
  ...
  LEFT JOIN surat_tegur4 d ON d.npwpd = a.npwpd_perusahaan 
  ...
  GROUP BY a.id")->row();
		...
		$idd_tgl2			= explode("/",$data->tgl2);
		$dd11				= $idd_tgl2[0];
		$dd22				= $this->msistem->v_bln($idd_tgl2[1]);
		$dd33				= $idd_tgl2[2];
		$tgl_terbit2		= $dd11." ".$dd22." ".$dd33;
		
		$no_tegur = $data->no_tegur_1;
		$no_tegur2 = $data->no_tegur_2;
	...
	<tr>
		  ...
		  <td width="190" colspan="1" style="font-family: Arial,Helvetica Neue,Helvetica,sans-serif,Helvetica Neue,Helvetica,sans-serif"><div align="left"><font size="11">Jambi,        '.$mounth.' '.$year.'.</font></div></td>	
  		</tr>
	<tr>
		  <td colspan="4"><br/></td>
  		</tr>
	<tr>
		<td width="20"></td>  
		<td colspan="3">
			<table width="385" border="0" style="font-family: Arial,Helvetica Neue,Helvetica,sans-serif,Helvetica Neue,Helvetica,sans-serif">
				<tr>
		...
		<tr>
					...
					<td width="235"><div align="left"><font size="16" style="font-family: Arial,Helvetica Neue,Helvetica,sans-serif,Helvetica Neue,Helvetica,sans-serif"><u><b>SURAT TEGURAN III</b></u></font><br><font size="11" style="font-family: Arial,Helvetica Neue,Helvetica,sans-serif,Helvetica Neue,Helvetica,sans-serif">&nbsp;&nbsp;Nomor   : 973/         /BPPRD.</br></font></div></td>
				</tr>
		<tr>
			<td>
			</td>
        ...
        <tr>
			<td width="40"></td>
			<td width="489" colspan="3" align="justify" style="font-family: Arial,Helvetica Neue,Helvetica,sans-serif,Helvetica Neue,Helvetica,sans-serif"><font size="11"><font color="white">====</font>Menindaklanjuti Surat Teguran I Nomor : '.$no_tegur.' tertanggal '.$tgl_terbit.' dan Surat Teguran II Nomor : '.$no_tegur2.' tertanggal '.$tgl_terbit2.' Perihal Tunggakan  <b>Pajak '.$nama.''.$namrek1.'</b>, diberitahukan kepada Saudara/i bahwa berdasarkan pembukuan kami usaha '.$namrek.' Saudara/i mempunyai hutang pajak terhitung dari bulan '.$tunggakan.' dengan NPWPD '.$npwpd.'.</font></td>
		</tr>
		...
		<tr style="line-height:10%;">
		 ...
		 <tr>
			<td width="40"></td>
			<td width="489" colspan="3" align="justify" style="font-family: Arial,Helvetica Neue,Helvetica,sans-serif,Helvetica Neue,Helvetica,sans-serif,Helvetica Neue,Helvetica,sans-serif,Helvetica Neue,Helvetica,sans-serif"><font size="11"><font color="white">====</font>'.$cetak.'</font></td>
		</tr>
		...
		<tr>
			<td width="40"></td>
			<td width="489" colspan="3" align="justify" style="font-family: Arial,Helvetica Neue,Helvetica,sans-serif,Helvetica Neue,Helvetica,sans-serif"><font size="11"><font color="white">====</font>Sehubungan dengan hal tersebut diatas, bersama ini diminta kepada Saudara/i agar segera menyetorkan hutang pajak tersebut paling lambat 7 (tujuh) hari sejak surat ini diterima ke Bendahara Penerima Badan Pengelola Pajak dan Retribusi Daerah Kota Jambi dengan terlebih dahulu mengambil Surat Ketetapan Pajak Daerah (SKPD) melalui Bidang Pendaftaran, Pendataan dan Penetapan.</font></td>
		</tr>	
		...
		<tr style="line-height:10%;">
		 ...
		 <tr>
			<td width="40"></td>
			<td width="489" colspan="3" align="justify" style="font-family: Arial,Helvetica Neue,Helvetica,sans-serif,Helvetica Neue,Helvetica,sans-serif"><font size="11"><font color="white">====</font>Demikian Surat ini disampaikan untuk menjadi perhatian, atas kepeduliannya diucapkan terima kasih.</font></td>
		</tr>
				<tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        ...
        <tr>
            ...
            <td width="320" align="center" style="font-family: Arial,Helvetica Neue,Helvetica,sans-serif,Helvetica Neue,Helvetica,sans-serif"><div align="center"><font size="11"><b>KEPALA BADAN</b></font></div></td>
		</tr>
        <tr>
        ...
        <tr style="line-height:80%;">
            ...
            <td width="94">&nbsp;</td>
            <td width="120">&nbsp;</td>
            <td width="200" align="center" style="font-family: Arial,Helvetica Neue,Helvetica,sans-serif,Helvetica Neue,Helvetica,sans-serif, line-height: 1em"><div align="left"><font size="11"><b><u>SUBHI, S.Sos, MM</u></b></font></div></td>
		</tr>
		<tr style="line-height:80%;">
			<td width="110">&nbsp;</td>
            <td width="94">&nbsp;</td>
            <td width="120">&nbsp;</td>
            <td width="200" align="center" style="font-family: Arial,Helvetica Neue,Helvetica,sans-serif,Helvetica Neue,Helvetica,sans-serif, line-height: 1em"><div align="left"><font size="11"><b>Pembina Utama Muda</b></font></div></td>
		</tr>
        <tr style="line-height:80%;">
			<td width="110">&nbsp;</td>
	    <td width="94">&nbsp;</td>
            <td width="120">&nbsp;</td>
            <td width="200" align="center" style="font-family: Arial,Helvetica Neue,Helvetica,sans-serif,Helvetica Neue,Helvetica,sans-serif, line-height: 1em"><div align="left"><font size="11"><b>NIP. '.$nip1.'</b></font></div></td>
		</tr>
		<tr>
			<td>
			</td>
		...
		$pdf->lastPage();
		$pdf->Output('Surat_Tegur_III'.'.pdf', 'I');
	}
	...
	public function delete() {
		...
		if ($id=="" || $npwpd==""){
			...
			$sql = $this->db->query("DELETE FROM surat_tegur4 where npwpd='".$npwpd."' and id_surat_tegur='".$id."'");
			if($sql){
				$result = 1;
			}else{
				$result = 0;
	...
	public function data() {
		$grid = new GridConnector($this->db->conn_id);
		$grid->dynamic_loading(100); 
		$grid->render_sql("SELECT a.id_surat_tegur, a.no_teguran, a.no_tegur_1, a.no_tegur_2, a.npwpd, b.nama_perusahaan, DATE_FORMAT(a.tgl_surat,'%d/%m/%Y') as tgl_surat, DATE_FORMAT(a.tgl_surat2,'%d/%m/%Y') as tgl_surat2, DATE_FORMAT(a.tgl_surat3,'%d/%m/%Y') as tgl_surat3, b.alamat_perusahaan, a.kewajiban,a.pemilik_pimpinan,a.tunggakan ,c.nama_sptpd AS jenis_usaha FROM surat_tegur4 a 
LEFT JOIN identitas_perusahaan b ON a.npwpd = b.npwpd_perusahaan
LEFT JOIN master_sptpd c ON c.id = b.jenis_usaha GROUP BY a.id_surat_tegur","id","id_surat_tegur, no_teguran, no_tegur_1, no_tegur_2, tgl_surat, tgl_surat2, tgl_surat3, npwpd, nama_perusahaan, alamat_perusahaan, kewajiban,pemilik_pimpinan,tunggakan, jenis_usaha");	
	}
	//-----fadil
