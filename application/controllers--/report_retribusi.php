...
class report_retribusi extends MY_Controller {
    ...
    function realisasi_retribusi(){
        $data['tahun'] = $this->msistem->tahun();
		$this->load->view('report_retribusi/realisasi', $data);
    }
	...
	function cetak_realisasi(){
		...
		$report = '';
		$report .=
			'<h2 align="center">LAPORAN REALISASI PENERIMAAN RETRIBUSI '.$p.' TAHUN '.$b[0].'</h2>';
			
		$report .=
			'<table border="1">
				<tr>
					<td rowspan="2" width="20" height="10" align="center"><strong>NO.</strong></td>
					<td rowspan="2" width="80" height="10" align="center"><strong>NAMA WAJIB RETRIBUSI</strong></td>
					<td rowspan="2" width="100" height="12" align="center"><strong>ALAMAT WAJIB RETRIBUSI</strong></td>
					<td rowspan="2" width="45" height="12" align="center"><strong>PIUTANG </strong></td>
		...
		$sql = $this->db->query("SELECT DISTINCT(view_perusahaan.npwpd_perusahaan) AS npwpd_perusahaan, 
        view_perusahaan.nama_perusahaan, view_perusahaan.alamat_perusahaan FROM view_perusahaan
        LEFT JOIN ssrd ON view_perusahaan.npwpd_perusahaan = ssrd.npwpd WHERE ssrd.tahun_transaksi = '".$tahun."'
        order by view_perusahaan.nama_perusahaan ");
...
(SELECT SUM(pembayaran_ret.setoran_wp) FROM ssrd LEFT JOIN pembayaran_ret ON pembayaran_ret.no_ssrd = ssrd.no_ssrd WHERE ssrd.npwpd = '".$npwpd."' AND ssrd.tahun_transaksi < '".$tahun."' $qr) AS piutang,
(SELECT SUM(pembayaran_ret.setoran_wp) FROM ssrd LEFT JOIN pembayaran_ret ON pembayaran_ret.no_ssrd = ssrd.no_ssrd WHERE ssrd.npwpd = '".$npwpd."' AND MONTH(ssrd.tanggal) = '01' AND ssrd.tahun_transaksi = '".$tahun."' $qr) AS s_1,
(SELECT SUM(pembayaran_ret.setoran_wp) FROM ssrd LEFT JOIN pembayaran_ret ON pembayaran_ret.no_ssrd = ssrd.no_ssrd WHERE ssrd.npwpd = '".$npwpd."' AND MONTH(ssrd.tanggal) = '02' AND ssrd.tahun_transaksi = '".$tahun."' $qr) AS s_2,
(SELECT SUM(pembayaran_ret.setoran_wp) FROM ssrd LEFT JOIN pembayaran_ret ON pembayaran_ret.no_ssrd = ssrd.no_ssrd WHERE ssrd.npwpd = '".$npwpd."' AND MONTH(ssrd.tanggal) = '03' AND ssrd.tahun_transaksi = '".$tahun."' $qr) AS s_3,
(SELECT SUM(pembayaran_ret.setoran_wp) FROM ssrd LEFT JOIN pembayaran_ret ON pembayaran_ret.no_ssrd = ssrd.no_ssrd WHERE ssrd.npwpd = '".$npwpd."' AND MONTH(ssrd.tanggal) = '04' AND ssrd.tahun_transaksi = '".$tahun."' $qr) AS s_4,
(SELECT SUM(pembayaran_ret.setoran_wp) FROM ssrd LEFT JOIN pembayaran_ret ON pembayaran_ret.no_ssrd = ssrd.no_ssrd WHERE ssrd.npwpd = '".$npwpd."' AND MONTH(ssrd.tanggal) = '05' AND ssrd.tahun_transaksi = '".$tahun."' $qr) AS s_5,
(SELECT SUM(pembayaran_ret.setoran_wp) FROM ssrd LEFT JOIN pembayaran_ret ON pembayaran_ret.no_ssrd = ssrd.no_ssrd WHERE ssrd.npwpd = '".$npwpd."' AND MONTH(ssrd.tanggal) = '06' AND ssrd.tahun_transaksi = '".$tahun."' $qr) AS s_6,
(SELECT SUM(pembayaran_ret.setoran_wp) FROM ssrd LEFT JOIN pembayaran_ret ON pembayaran_ret.no_ssrd = ssrd.no_ssrd WHERE ssrd.npwpd = '".$npwpd."' AND MONTH(ssrd.tanggal) = '07' AND ssrd.tahun_transaksi = '".$tahun."' $qr) AS s_7,
(SELECT SUM(pembayaran_ret.setoran_wp) FROM ssrd LEFT JOIN pembayaran_ret ON pembayaran_ret.no_ssrd = ssrd.no_ssrd WHERE ssrd.npwpd = '".$npwpd."' AND MONTH(ssrd.tanggal) = '08' AND ssrd.tahun_transaksi = '".$tahun."' $qr) AS s_8,
(SELECT SUM(pembayaran_ret.setoran_wp) FROM ssrd LEFT JOIN pembayaran_ret ON pembayaran_ret.no_ssrd = ssrd.no_ssrd WHERE ssrd.npwpd = '".$npwpd."' AND MONTH(ssrd.tanggal) = '09' AND ssrd.tahun_transaksi = '".$tahun."' $qr) AS s_9,
(SELECT SUM(pembayaran_ret.setoran_wp) FROM ssrd LEFT JOIN pembayaran_ret ON pembayaran_ret.no_ssrd = ssrd.no_ssrd WHERE ssrd.npwpd = '".$npwpd."' AND MONTH(ssrd.tanggal) = '10' AND ssrd.tahun_transaksi = '".$tahun."' $qr) AS s_10,
(SELECT SUM(pembayaran_ret.setoran_wp) FROM ssrd LEFT JOIN pembayaran_ret ON pembayaran_ret.no_ssrd = ssrd.no_ssrd WHERE ssrd.npwpd = '".$npwpd."' AND MONTH(ssrd.tanggal) = '11' AND ssrd.tahun_transaksi = '".$tahun."' $qr) AS s_11,
(SELECT SUM(pembayaran_ret.setoran_wp) FROM ssrd LEFT JOIN pembayaran_ret ON pembayaran_ret.no_ssrd = ssrd.no_ssrd WHERE ssrd.npwpd = '".$npwpd."' AND MONTH(ssrd.tanggal) = '12' AND ssrd.tahun_transaksi = '".$tahun."' $qr) AS s_12
FROM ssrd LEFT JOIN pembayaran_ret ON pembayaran_ret.no_ssrd = ssrd.no_ssrd")->row();
...
FROM sspd")->row();
	...
	function data_realisasi($tahun=""){
		...
		$qr = '';
		$sql = $this->db->query("SELECT DISTINCT(view_perusahaan.npwpd_perusahaan) AS npwpd_perusahaan, view_perusahaan.nama_perusahaan,
         view_perusahaan.alamat_perusahaan FROM view_perusahaan LEFT JOIN ssrd ON view_perusahaan.npwpd_perusahaan = ssrd.npwpd
          WHERE ssrd.tahun_transaksi = '".$tahun."' $qr order by view_perusahaan.nama_perusahaan");
