...
if($type=='excel'):
	...
	header('Content-Disposition: attachment; filename=lap_penerimaan.xls');	
endif;
?>
...
<table border=1>
	<tr>
		...
		<td align="center"><strong>OMSET</strong></td>
		...
		foreach($rc->result() as $rs){
			...
			echo
				'<tr>
					...
					<td align="center">'.$this->msistem->c_bln($rs->masa_pajak1)." - ".$this->msistem->c_bln($rs->masa_pajak2).' '.$thn.' </td>
					<td align="center">'.$rs->tanggal.'&nbsp;</td>
					<td align="right">'.number_format($rs->dp,2,",",".").'</td>
