...
if($type=='excel'):
	...
	header('Content-Disposition: attachment; filename=sptpd_sudah_bayar.xls');	
endif;
?>
...
?>
<h2 align="center">Laporan SPTPD Sudah Bayar (Self Assesment)</h2>
...
<table border=1>
	...
	<tr>
		<td align="center"><strong>TGL SPTPD</strong></td>
