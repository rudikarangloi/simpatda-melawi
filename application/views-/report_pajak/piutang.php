...
<div align="center">
	...
	<h2>Laporan Piutang Pajak Daerah</h2>
	<form name="tetap" id="tetap">
    	<table>
			...
			<tr>
            	<td style="padding-left:15px;"></td>
                <td> 
                <input type="button" name="xls" id="xls" onclick="cetak_rekap();" value="Cetak Rekapitulasi Piutang" style="padding-left:20px; padding-right:20px" />
                <input type="button" name="xls" id="xls" onclick="cetak_penyisihan();" value="Cetak Penyisihan Piutang" style="padding-left:20px; padding-right:20px" />
				</td>
            </tr>
        </table>
    </form>
