...
<div align="center">
	...
	<h2>Laporan Daftar Penerimaan Pajak</h2>
	<form name="tetap" id="tetap">
    	<table>
            ...
            <tr>
                ...
                <input type="hidden" name="tpdf" id="tpdf" onclick="pdf();" value="Cetak to PDF" style="padding-left:20px; padding-right:20px" />&nbsp;<input type="button" name="xls" id="xls" onclick="txls();" value="Cetak" style="padding-left:20px; padding-right:20px" />&nbsp;Reklame -> 
				<input type="button" name="xls2" id="xls2" onclick="txls2();" value="Cetak2" style="padding-left:20px; padding-right:20px" />Air Tanah ->
				<input type="button" name="xls3" id="xls3" onclick="txls3();" value="Cetak3" style="padding-left:20px; padding-right:20px" />PBB & BPHTB ->
                <input type="button" name="xls3" id="xls3" onclick="txls4();" value="Cetak4" style="padding-left:20px; padding-right:20px" />
                </td>
            </tr>
        </table>
    </form>
...
function pdf() {
	...
	window.open('<?php echo site_url(); ?>/report_pajak2/cetak_ket2?full='+full, '', 'height=700,width=1000,scrollbars=yes');
}
...
function txls(){
	...
	window.open('<?php echo site_url(); ?>/report_pajak2/excel_ket2?full='+full, '', 'height=700,width=1000,scrollbars=yes');
}
...
function txls2(){
	...
	full = awal+'|'+akhir+'|'+document.tetap.jenis_pajak.value;
	window.open('<?php echo site_url(); ?>/report_pajak2/excel_ket22?full='+full, '', 'height=700,width=1000,scrollbars=yes');
}
...
function txls3(){
	...
	full = awal+'|'+akhir+'|'+document.tetap.jenis_pajak.value;
	window.open('<?php echo site_url(); ?>/report_pajak2/excel_ket222?full='+full, '', 'height=700,width=1000,scrollbars=yes');
}
...
function txls4(){
	...
	full = awal+'|'+akhir+'|'+document.tetap.jenis_pajak.value;
	window.open('<?php echo site_url(); ?>/report_pajak2/excel_ketpbb?full='+full, '', 'height=700,width=1000,scrollbars=yes');
}
...
function tampil(){
	...
	mygrid.clearAll();
	mygrid.loadXML("<?php echo site_url(); ?>/report_pajak2/data_ket2/"+awal+"/"+akhir+"/"+pajak,function() {
		awal2 = s[2]+'-01-01';
		if(akhir2<awal2){
...
mygrid.setHeader("No. ,Nama, Alamat Perusahaan, NPWPD, No SSPD, Nama Usaha, Tanggal Bayar, Masa Pajak , Pokok, Denda, Jumlah,Status SKP",//11
...
mygrid.setInitWidths("40,200,200,150,110,150,110,110,110,110,110,110");
mygrid.setColAlign("center,left,left,center,left,center,center,center,right,right,right,center");
mygrid.setColTypes("ro,ro,ro,ro,ro,ro,ro,ron,ron,ron,ron,ron");
mygrid.setNumberFormat("0,000",8,",",".");
mygrid.setNumberFormat("0,000",9,",",".");
mygrid.setNumberFormat("0,000",10,",",".");
mygrid.setColSorting("str,str,str,str,str,str,str,str,int,int,int,str");
