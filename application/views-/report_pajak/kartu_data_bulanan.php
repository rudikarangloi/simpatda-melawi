...
<div align="center">
	...
	<h2>Laporan Penerimaan Pajak Berdasarkan SKPD<br />Surat Ketetapan Pajak Daerah</h2>
	<form name="kartu" id="kartu">
    	<table>
        	...
        	<tr>
            	<td style="padding-left:15px;">Bulan Setoran</td>
...
//	}
	...
	awl = document.kartu.awal.value;
    aw =  awl.split("/");
	awal = aw[2]+'-'+aw[1]+'-'+aw[0];
	
	akh = document.kartu.akhir.value;
    ak  = akh.split("/");
	akhir = ak[2]+'-'+ak[1]+'-'+ak[0];
	
	statusLoading();
	mygrid.clearAll();
	mygrid.loadXML("<?php echo site_url(); ?>/report_pajak/data_kartu_skpd/"+awal+"/"+akhir,function() {
		//cariData();
		statusEnding();
	});
}
...
mygrid.setHeader("NO.,NO SKPD,TANGGAL SKPD, NO. SSPD, TGL SSPD, NO. TBP, URAIAN PAJAK, JUMLAH SETORAN, KET");

mygrid.setInitWidths("40,150,150,150,150,150,150,150,150");
...
mygrid.setColSorting("str,str,str,str,str,int,int,int,str");
