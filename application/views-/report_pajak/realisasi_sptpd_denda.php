...
<div align="center">
	...
	<h2>Laporan Realisasi Penerimaan Denda Pajak Berdasarkan SPTPD</h2>
...
function pdf() {
	...
	window.open('<?php echo site_url(); ?>/report_pajak/cetak_realisasi_sptpd_denda?full='+full, '', 'height=700,width=1000,scrollbars=yes');
}
...
function tampil(){
	...
	mygrid.clearAll();
	mygrid.loadXML("<?php echo site_url(); ?>/report_pajak/data_realisasi_sptpd_denda/"+document.tetap.jenis_pajak.value+"/"+document.tetap.tahun.value,function() {
