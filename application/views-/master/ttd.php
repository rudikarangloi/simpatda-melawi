...
<h2 style="margin:30px 5px 25px 30px;">Master Tanda Tangan</h2>
<div class="oval_big2">

<div id="topnav" style="width: auto;"></div>
<div id="gridboxfrmData" style="width:550px; height:300px;"></div><br />
...
<script language="javascript">
	...
	gridfrmData.setHeader("ID, Nama Pegawai, NIP, Jabatan");
	gridfrmData.setInitWidths("90,200,150,200")
	gridfrmData.setColAlign("left,left,left,left")
	gridfrmData.setColTypes("ro,ed,ed,ed");
	gridfrmData.setColumnHidden(0,true);
	gridfrmData.enableMultiselect(true);
	gridfrmData.init();
	gridfrmData.setSkin("dhx_skyblue");
	gridfrmData.loadXML("<?php echo site_url(); ?>/master_setting/data_ttd");
	initDP();

	var dpps = "";
	function initDP() {
		dpps = new dataProcessor("<?php echo site_url(); ?>/master_setting/data_ttd");
