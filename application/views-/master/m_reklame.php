...
<h2 style="margin:30px 5px 25px 30px;">Master Tarif Reklame</h2>
<div class="oval_big2">

<div id="topnav" style="width: auto;"></div>
<div id="gridboxfrmData" style="width:700px; height:300px;"></div><br />
...
<script language="javascript">
	...
	gridfrmData.setHeader("ID, Jenis Reklame, Lokasi, Waktu, Tarif");
	gridfrmData.setInitWidths("90,200,150,150,100")
	gridfrmData.setColAlign("left,left,left,left,left")
	gridfrmData.setColTypes("ed,ed,ed,ed,ed");
	gridfrmData.enableMultiselect(true);
	gridfrmData.init();
	gridfrmData.setSkin("dhx_skyblue");
	gridfrmData.loadXML("<?php echo site_url(); ?>/master_setting/data_reklame");
	initDP();

	var dpps = "";
	function initDP() {
		dpps = new dataProcessor("<?php echo site_url(); ?>/master_setting/data_reklame");
