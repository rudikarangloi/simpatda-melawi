...
<script type="text/javascript" language="javascript">
	...
	var iViewClass	= iBaseUrl + 'index.php' + '/sptpd_listrik/data_sptpd';
</script>
<style>
		body {
			background:#FFF;
...
<h2 style="margin:30px 5px 25px 30px;">SPTPD Penerangan Jalan</h2>
	
<div id="a_tabbar" style="width:1000px; height:540px; margin-left:30px;"></div>
  <div id="C1" style="background-color: #B3D9F0">
			<form name="frmData" id="frmData" method="post">
                ...
                <table>
					...
					<tr>
						<td style="padding-left:15px;" valign="top">1. Gol. Rekening</td>
						<td><input type="text" name="txtgolhotel" id="txtgolhotel" value="4.1.1.05.01" disabled/>&nbsp;</td>
					</tr>
					<!--<tr>
...
<script language="javascript">
	...
	function lihat3() {
		...
		gridPKR.clearAll();
		gridPKR.loadXML("<?php echo site_url(); ?>/sptpd_listrik/load_perusahaan/"+op+"/"+nilai,function() {
			statusEnding();
		});
	}
	...
	grid.setHeader("ID, NPWPD,No SPTPD, Nama Perusahaan, Alamat, Cara Hitung, Golongan, Masa Pajak1, Masa Pajak2, Diterima Tgl, Jumlah Bayar, Petugas, Omset",null,["text-align:center","text-align:center","text-align:center","text-align:center"]);
	...
	grid.setInitWidths("50,150,150,170,100,100,100,100,100,100,100,100,100");
	grid.setColAlign("center,left,left,left,left,left,left,left,left,left,right,left,left");
	grid.setColTypes("ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro");
	grid.setColSorting("str,str,str,str,str,str,str,str,str,date,int,str,int");
	...
	grid.loadXML("<?php echo site_url(); ?>/sptpd_listrik/data_sptpd");
	grid.init();
			...
			if(name=='dispenda'){
				...
				if(confrm) {
					var postStr = 
						...
						dhtmlxAjax.post(base_url+'index.php/sptpd_listrik/delete_sptpd', postStr, responePOST);	
				}
				document.frmData.btnaddnew.disabled=false;
				document.frmData.btnsimpan.disabled=true;
				document.frmData.btnedit.disabled=true;
