...
<script type="text/javascript" language="javascript">
	...
	var iViewClass	= iBaseUrl + 'index.php' + '/sptpd_parkir/data_bank';
</script>
<style>
		body {
			background:#FFF;
...
<h2 style="margin:30px 5px 25px 30px;">SPTPD Parkir ( Bank )</h2>
			...
			<form name="frmData" id="frmData" method="post">
                ...
                <table>
					...
					<tr>
						...
						<td><input type="text" name="txttglmasapajak1" id="txttglmasapajak1" size="12" readonly /> &nbsp;
...
<script language="javascript">
	...
	grid.loadXML("<?php echo site_url(); ?>/sptpd_parkir/data_bank");
	grid.init();
