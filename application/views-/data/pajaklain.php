...
<script language="javascript">
    ...
    <div style="height:100%; overflow:auto;">
        ...
        <div id="content" style="overflow: auto;">
            <h2 style="margin:30px 5px 25px 30px;">Input Pendapatan Lainnya</h2>

            <div id="a_tabbar" style="width:850px; height:590; margin-left:30px;"></div>
  				<div id="C1" style="background-color: #B3D9F0">
                <form name="frmData" id="frmData" action="" method="post" onSubmit="" >
                    <table width="1000px" border="0">
                        <!--<tr>
                            <td width="441" style="padding-left:15px;">No. Inputan</td>
                            <td width="331"><input name="sptpd_1" type="hidden" id="sptpd_1" size="15" readonly style="background-color:#FFFFCC;" > 
                          <input name="sptpd_2" type="hidden" id="sptpd_2" size="10" readonly style="background-color:#FFFFCC;" ></td>
                          <td width="100">&nbsp;</td>
                          <td width="300">&nbsp;</td>
                        </tr>-->
                       <!-- <tr>
                        ...
                        <tr>
                            <td width="441" style="padding-left:15px;">NPWPD</td>
                                ...
                                <input type="hidden" name="npwpd" id="npwpd" size="32" style="background-color:#FFCC99; text-transform:uppercase;" />
                                <input name="btnCari" id="btnCari" type="hidden" onClick="searchNPWPD()" value="Cari" style="padding-left:20px; padding-right:20px" disabled/>                            </td>
                            <td width="100">&nbsp;</td>
                            <td width="300">&nbsp;</td>
                        </tr>-->
                        <tr>
                        ...
                        <tr>
                           <!-- <td style="padding-left:15px;">Alamat Usaha</td>
                            ...
                            <td style="padding-left:15px;">Tanggal Input</td>
                       ...
                       <tr>
							...
							<td style="padding-left:15px;">User Input</td>
						...
						<tr>
                            ...
                            <td>
                                <select id="sifatp" name="sifatp" style="width:300px;" disabled="disabled" onchange="getSifat();">
                                	<option value=""></option>
                                    <option value="Permanen">Bersifat Permanen</option>									
						...
						<tr>
                         <!--    <td style="padding-left:15px;">Jenis Reklame Permanen</td>
                            <td>
                                <select id="gjenisrek" name="gjenisrek" style="width:300px;" disabled="disabled" onchange="getTipe();">
                                	<option value=""></option>
                                   <option value="1">Megatron</option>									
									<option value="2">Videotron</option>									
                                    <option value="3">Multivision</option>									
									<option value="4">Bando</option>									
									<option value="5">Billboard</option>									
									<option value="6">Papan Merk</option>									
									<option value="7">Panel Baliho</option>									
									<option value="8">Neon Box</option>									
									<option value="9">Box Kendaraan</option>                                    
									<option value="10">Reklame Apung (kendaraan air) yang diam ditempat</option>
									 <?php 
									foreach($jnsReklame->result() as $rs) {
						...
						<tr>
                            <td style="padding-left:15px;">Jenis Rekening</td>
                            <td>
                                <select id="gjenisrek2" name="gjenisrek2" style="width:300px;" disabled="disabled" onchange="crek_pajak();">
                                	<option value=""></option>
                               <!--     <option value="7">Spanduk</option>									
                                    <option value="8">Umbul-umbul</option>									
                                    <option value="9">Layar Toko</option>									
                                    <option value="10">Tenda, Vertikal Banner</option>									
                                    <option value="11">Reklame Gantung, Sticker, Poster</option>                                    
									<option value="12">Reklame Selebaran</option>                                    
									<option value="13">Reklame Udara</option>   -->  
									 <?php 
									foreach($jns_rek->result() as $rs) {
						 ...
						 <tr>
                            <td style="padding-left:15px;">Penerimaan</td>
                            <td><input type="text" name="penerimaan" id="penerimaan"  size="25" disabled/></td>
                        </tr>
						 <tr>
                            <td style="padding-left:15px;">Nomor Bukti Transfer</td>
                            <td><input type="text" name="bukti" id="bukti"  size="25" disabled/></td>
                        </tr>
						<tr>
							<td style="padding-left:15px;">Uraian</td>
						</tr>
						<tr>
							<td style="padding-left:15px;"></td>
							<td colspan="3"><textarea name="uraian" id="uraian" cols="25" rows="3"></textarea></td>
						</tr>
                            ...
                            <td>
                                <select id="jenis" name="jenis" style="width:300px;" disabled="disabled" onchange="getType();">
									...
									foreach($dReklame->result() as $rs) {
											echo "<option value=".$rs->kd_rek."|".$rs->nm_rek.">".$rs->nm_rek."</option>";
										}
									?>
                                </select>                            </td>
                            <td>&nbsp;</td>
                        ...
                        <tr>
                          <td style="padding-left:15px;">Judul Reklame</td>
                          <td colspan="2"><input type="text" name="teks_reklame" id="teks_reklame" size="54" disabled="disabled"/></td>                          
                          <td>&nbsp;</td>
                        </tr>
                        <tr>
                          <td style="padding-left:15px;">Waktu Pasang</td>
                          <td>
                          <select id="waktu_pasang" name="waktu_pasang" disabled="disabled" onchange="getSelama();">
                        ...
                        <!--<tr>
                          <td style="padding-left:15px;">Lokasi pasang</td>
						   <td>
                                <select id="lokasi_pasang1" name="lokasi_pasang1" style="width:390px;" onchange="get_kawasan();" disabled="disabled" >
                                	<option value=""></option>
                                    <?php 
									foreach($jlnReklame->result() as $rs) {
											echo "<option value=".$rs->no.">".$rs->nama_jalan."</option>";
										}
									?>
                                </select>                            </td>
                         ...
                         <td colspan="2"><input type="text" name="lokasi_pasang6" id="lokasi_pasang6" size="50" disabled="disabled"/></td>
						  ...
						  <!--<tr>
                          <td style="padding-left:15px;">Ketinggian Reklame</td>
						   <td>
                                <select id="tinggi" name="tinggi" style="width:180px;" disabled="disabled">
                                	<option value=""></option>
                                    <?php 
									foreach($tinggiReklame->result() as $rs) {
											echo "<option value=".$rs->id.">".$rs->ketinggian."</option>";
										}
									?>
                                </select>                            </td>
						...
						<tr>
                          <td style="padding-left:15px;">Lebar Jalan</td>
						  <td><input name="lebar" type="text" id="lebar" size="20"  style="text-align:left" disabled="disabled" /></td>
						 <td>
                                <select id="lebar" name="lebar" style="width:100px;" disabled="disabled">
                                	<option value=""></option>
                                    <?php 
									foreach($lbrjln->result() as $rs) {
											echo "<option value=".$rs->id.">".$rs->lebar."</option>";
										}
									?>
                                </select>                            </td>
						...
						<tr>
                          <td style="padding-left:15px;">Sudut Pandang</td>
						   <td>
                                <select id="sudut" name="sudut" style="width:100px;" disabled="disabled">
                                	<option value=""></option>
                                    <?php 
									foreach($sudut->result() as $rs) {
											echo "<option value=".$rs->id.">".$rs->sudut_pandang."</option>";
										}
									?>
                                </select>                            </td>
 ...
 <!--                       <tr>
                       ...
                       <!--  <tr>
                          <td style="padding-left:15px;"><table width="200" border="0">
                           <tr>
                              <td><div align="center">Penerimaan</div></td>
                             ...
                             <td><div align="center">Harga Dasar</div></td>
                              ...
                              <td>&nbsp;</td>
								...
								<td><input name="kawasan" type="text" id="kawasan" size="3"  style="text-align:center" disabled="disabled" /></td>
                              <!--<td style="width:250px;"><select name="kawasan" id="kawasan" onchange="getnsl()" disabled="disabled">
                                <option>:: Kawasan ::</option>
								<option value="X">Kawasan I</option>
                                <option value="A">Kawasan II</option>
                                <option value="B">Kawasan III</option>
                                <option value="C">Kawasan IV</option>
								<option value="D">Kawasan V</option>                    
							  </select>                            </td>
							 ...
							 <td><input name="cnsl" type="text" id="cnsl" size="3" style="text-align:center" disabled="disabled" /></td>
                              ...
                              <td><input type="button" name="htg2" id="htg2" value="HITUNG" onclick="get_ketetapan()" disabled="disabled" /></td>-->
                              <!--<td><input type="button" name="ubah" id="ubah" value="UBAH REKLAME" onclick="ubahReklame()" disabled="disabled" /></td>-->
						 </table>
						
						  <table width="700px" border="0">
							<tr>
							   <td align="right"> <input type="button" name="tmbh" id="tmbh" value="TAMBAH" onclick="tambahRow()" disabled="disabled" />&nbsp;<input type="button" name="krg" id="krg" onclick="hapusData();" disabled="disabled" value="HAPUS"></td>
                            </tr>
                          </table>
                        </tr>
						</table>
                        ...
                        <td>&nbsp;</td><!--
                        	...
                        	<td colspan="2"><span style="float:right">Jumlah Penerimaan
                        ...
                        <tr>
                            <td colspan="4" style="padding-left:15px; background-color:#FFCC99;">
                                <input type="hidden" name="btnnew" id="button" value="BARU" onClick="newEntry();" style="width:90px;">
                                ...
                                <input type="hidden" value="CETAK" onclick="cetak1()" name="cetak" disabled="" style="width:90px;"><!--<input type="button" value="STIKER" onclick="stiker()" name="stiker1" disabled="" style="width:90px;">-->
								<input type="hidden" value="CETAK" onclick="cetak_per()" name="cetak2" disabled="" style="width:90px;"></td>
...
function format_number_digit(angka) {
...
function luasNya(){
	...
	document.frmData.luas.value = format_number_digit(pjg*lbr);
//	alert('tesss');
}
...
/* document.frmData.tinggi.value = "";
document.frmData.lebar.value = "";
document.frmData.sudut.value = ""; */
...
function hapusData(){
	...
	function tambahRow(){
		...
		if(document.frmData.penerimaan.value!=''){
			var grek = document.frmData.kode_rek1.value;
			var grekn= document.frmData.nama_rek1.value;
			//var skpd  = document.getElementById('nama_perusahaan');
			var skpd  = document.frmData.nm2.value;
			var ktp = document.frmData.penerimaan.value;	
			var btid = document.frmData.buatidx.value;	
			//var skpds = skpd.options[skpd.selectedIndex].text
			var id = mygrid.uid();			
			var posisi = mygrid.getRowsNum();						
			mygrid.addRow(id,[btid,grek,grekn,skpd,ktp],posisi);		//17	
			mygrid.selectRowById(id);
			...
			alert("Isi kolom penerimaan");
		}
	}
	
	mygrid = new dhtmlXGridObject('gridbox');
    mygrid.setImagePath("<?php echo base_url(); ?>/assets/codebase_grid/imgs/");
    mygrid.setHeader("btid, Kode Rekening, Nama Rekening, SKPD Pengelola,Penerimaan,no_sptpd",null,["text-align:center","text-align:center","text-align:center","text-align:center","text-align:center","text-align:center"]);    
    mygrid.setInitWidths("100,180,180,200,140,100");
    mygrid.setColAlign("center,center,center,center,center,center");
    mygrid.setColTypes("ro,ro,ro,ro,ron,ro");
...
var mdp = "";
function runmdp(){
mdp = new dataProcessor("<?php echo base_url()."index.php/pajaklain/reklame_detail"; ?>");
...
mdp.attachEvent("onAfterUpdate", function(){
	...
	document.frmData.cetak2.disabled = false;
...
//	}
	...
	function cetak_per() {
		...
		var b = document.frmData.sptpd_2.value;
		var c = a+'/'+b;
		window.open('<?php echo site_url(); ?>/pajaklain/cetak2?sptpd='+c, '', 'height=700,width=1000,scrollbars=yes');
	}
...
//		}
        ...
        function newEntry(){			
			...
			document.frmData.cetak2.disabled = true; */
	...
	function buat_id(){
		var postCek =
			"cek_baru=" + "baru";
		statusLoading();
		dhtmlxAjax.post(base_url+'index.php/pajaklain/buatid', postCek, resPOSTid);
	}
	...
	function resPOSTid(loader) {
        ...
        function bersih(){
			...
			document.frmData.uraian.value = "";
			document.frmData.bukti.value = "";
        ...
        function aktif(){
			...
			*///document.frmData.petugas.disabled = false;
			...
			document.frmData.penerimaan.disabled = false;
			document.frmData.bukti.disabled = false;
			//document.frmData.lokasi_pasang1.disabled = false;
			//document.frmData.tinggi.disabled = false;
			//document.frmData.lebar.disabled = false;
			//document.frmData.sudut.disabled = false;
        ...
        function disable(){
           ...
           // document.frmData.sifatp.disabled = true;
			...
			document.frmData.bukti.disabled = true;
			...
			//document.frmData.tinggi.disabled = true;
			//document.frmData.lebar.disabled = true;
			//document.frmData.sudut.disabled = true;
	...
	function cek(){
		...
		statusLoading();
		dhtmlxAjax.post(base_url+'index.php/pajaklain/ricek', postCek, resPOST);
	}
	...
	function simpan2(){			
		...
		terima = arrTgl_3[2]+"-"+arrTgl_3[1]+"-"+arrTgl_3[0];
		/* skpd = document.frmData.nama_perusahaan.value ;
		tngx = skpd.replace(/&gt;/g,">"); */
		
		    var poststr =
                'sptpd_1=' + document.frmData.sptpd_1.value +
                '&sptpd_2=' + document.frmData.sptpd_2.value +
			'&nama_perusahaan=' + document.frmData.nm2.value +
			'&kd_skpd=' + document.frmData.kd2.value +
			'&petugas=' + document.frmData.petugas.value +
			'&tgl_terima=' + terima +
			'&buatidd=' + document.frmData.buatidx.value +
			'&uraian=' + document.frmData.uraian.value +
			'&jml_dibayar=' + document.frmData.jml_dibayar.value +
			'&kd_rek=' + document.frmData.kode_rek1.value +
			'&bukti=' + document.frmData.bukti.value +
			'&nm_rek=' + document.frmData.nama_rek1.value +
            '&edit=' + document.frmData.edit.value ;           
            dhtmlxAjax.post("pajaklain/simpan", encodeURI(poststr), outputResponse);
        }
	...
	gridData.setHeader("No Inputan,Kode SKPD,Nama SKPD,Tanggal Input,Petugas Input,Jenis Rekening,Uraian,Jumlah Penerimaan");//7
	gridData.attachHeader("#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter");
	gridData.setInitWidths("150,100,180,100,100,100,190,100");
	gridData.setColAlign("center,center,left,center,center,center,left,center");
	gridData.setColTypes("ro,ro,ro,ro,ro,ro,ro,ron");
	...
	function loadData(){
	gridData.clearAll();	
	gridData.loadXML(base_url+"index.php/pajaklain/load_data",function() { 
        });
	...
	function selectData(id){
      ...
      //  document.frmData.npwpd.value = gridData.cells(id,1).getValue();
		...
		document.frmData.nama_perusahaan.value = gridData.cells(id,1).getValue(); //nama_perusahaan
		document.frmData.tgl_terima.value = gridData.cells(id,3).getValue(); //tgl-diterima
		document.frmData.petugas.value = gridData.cells(id,4).getValue(); //petugas
		document.frmData.gjenisrek2.value = gridData.cells(id,5).getValue(); //rekening
		document.frmData.uraian.value = gridData.cells(id,6).getValue(); //uraian
		document.frmData.sub_jumlah.value = format_number(gridData.cells(id,7).getValue()); //sub_jumlah	
		document.frmData.jml_dibayar.value = gridData.cells(id,7).getValue(); //jml_dibayar								
		//document.frmData.buatidx.value = gridData.cells(id,5).getValue(); 		
		           
            document.frmData.edit.value = "1";
		
		var no = gridData.cells(id,0).getValue().split('/').join('.');
		mygrid.clearAll();
		mygrid.loadXML("<?php echo base_url()."index.php/pajaklain/load_detail_edit/"?>"+no);	
			...
			if(name=='dispenda'){
				...
				if(cnf) {
					var postStr =
						...
						"&sptpd_2=" + document.frmData.sptpd_2.value;
					statusLoading();
					dhtmlxAjax.post(base_url+'index.php/pajaklain/hapus', postStr, function(loader) {
						result = loader.xmlDoc.responseText;
						alert(result);
						gridData.clearAll();
						loadData();
	...
	gridWP.setHeader("NPWPD,Nama Badan Usaha,Alamat,Pemilik,Insidentil");
	gridWP.setInitWidths("120,200,200,180,50");
	...
	gridWP.attachEvent("onRowDblClicked", function(id) {
		...
		closeBrg();
		//var npwpd = document.frmData.npwpd.value;
		//var kode_rekening = npwpd.substr(8,2);
		/* if(kode_rekening == "02"){
			document.getElementById('sifatp').value = "Insidentil";
			getSifat();
			document.getElementById('gjenisrek2').value = "7";
                        document.getElementById('kawasan').value = "X";
                        getnsl();
			getTipe();
		}else{
			document.getElementById('sifatp').value = "Permanen";
			getSifat();
			if(kode_rekening == "11"){
				document.getElementById('gjenisrek').value = "8";
				getTipe();
			}else if(kode_rekening == "05"){
				document.getElementById('gjenisrek').value = "9";
				getTipe();
			}
	...
	function cariDataWP() {	
		...
		statusLoading();
		gridWP.clearAll();	
		gridWP.loadXML(base_url+"index.php/pajaklain/cariDataWP/"+document.frmSrc.keyword.value+"/"+document.frmSrc.parameter.value,function() {  								
		statusEnding();
...
function addRowItem(arrIndx) { 
		...
		var row4= arr[3];
		var row5= arr[4];
        var row6= document.frmData.sptpd_1.value+"/"+document.frmData.sptpd_2.value;		
//		if(arr[0] != "") {
			mygrid.addRow(id,[row1,row2,row3,row4,row5,row6],posisi);
//		}
	}	
...
function sumColumn(ind) {
	...
	/* function getSifat(){
		if(document.frmData.sifatp.value == 'Permanen'){			
	...
	/*function getType(){
		...
		function getnsl(){
			...
			if(kawasan=="I" || kawasan=="i"){
				nsl = "6";				
			}else if(kawasan=="II" || kawasan=="ii"){
				nsl = "5.4";				
			}else if(kawasan=="III" || kawasan=="iii"){
				nsl = "4.8";				
			}else if(kawasan=="IV" || kawasan=="iv"){
				nsl = "4.2";				
			}
		...
		function getTipe(){
			...
			if (cek!=""){
				if(cek=="1"){
					...
					document.frmData.nama_rek1.value = "Megatron/Videotron/LED";
					//document.frmData.tarif.value = "750000";
					//document.frmData.trf.value = "20";
					//document.frmData.teks_reklame.value = "MEGATRON";
				}else
				if(cek=="2"){
					document.frmData.kode_rek1.value = "4.1.1.04.01";
					document.frmData.nama_rek1.value = "Bilboard - Tiang dengan penerangan";
					//document.frmData.tarif.value = "750000";
					//document.frmData.trf.value = "20";
					//document.frmData.teks_reklame.value = "VIDEOTRON";
				}else
				if(cek=="3"){
					document.frmData.kode_rek1.value = "4.1.1.04.01";
					document.frmData.nama_rek1.value = "Bilboard - Tiang tanpa penerangan";
					//document.frmData.tarif.value = "750000";
				//	document.frmData.trf.value = "20";
					//document.frmData.teks_reklame.value = "MULTIVISION";
				}else
				if(cek=="4"){
					document.frmData.kode_rek1.value = "4.1.1.04.01";
					document.frmData.nama_rek1.value = "Papan Nempel dengan penerangan";
					//document.frmData.tarif.value = "400000";
					//document.frmData.trf.value = "20";
					//document.frmData.teks_reklame.value = "BANDO";
				}else
				if(cek=="5"){
					document.frmData.kode_rek1.value = "4.1.1.04.01";
					document.frmData.nama_rek1.value = "Papan Nempel tanpa penerangan";
					//document.frmData.tarif.value = "300000";
					//document.frmData.trf.value = "20";
					//document.frmData.teks_reklame.value = "BILLBOARD";
				}else
				if(cek=="6"){
					document.frmData.kode_rek1.value = "4.1.1.04.01";
					document.frmData.nama_rek1.value = "Reklame Papan Merk";
					//document.frmData.tarif.value = "250000";
					//document.frmData.trf.value = "20";
					//document.frmData.teks_reklame.value = "PAPAN MEREK";
				}else
				if(cek=="7"){
					document.frmData.kode_rek1.value = "4.1.1.04.01";
					document.frmData.nama_rek1.value = "Reklame Panel Baliho";
					//document.frmData.tarif.value = "250000";
					//document.frmData.trf.value = "20";
					//document.frmData.teks_reklame.value = "BALIHO";
				}else
				if(cek=="8"){
					document.frmData.kode_rek1.value = "4.1.1.04.11";
					document.frmData.nama_rek1.value = "Reklame Neon Box";
					//document.frmData.tarif.value = "250000";
					//document.frmData.trf.value = "20";
					//document.frmData.teks_reklame.value = "NEON BOX";
				}else
				if(cek=="9"){
					document.frmData.kode_rek1.value = "4.1.1.04.05";
					document.frmData.nama_rek1.value = "Reklame Berjalan";
					//document.frmData.tarif.value = "250000";
					//document.frmData.trf.value = "20";
					//document.frmData.teks_reklame.value = "REKLAME BERJALAN";
				}else
				if(cek=="10"){
					document.frmData.kode_rek1.value = "4.1.1.04.05";
					document.frmData.nama_rek1.value = "Reklame Berjalan";
				...
				if(cek2=="6"){
					...
					document.frmData.nama_rek1.value = "Kain/Spanduk/Baliho/Umbul2";
					/*  document.frmData.tarif.value = "1500";
					document.frmData.trf.value = "20";
					document.frmData.teks_reklame.value = "SPANDUK";
					document.frmData.sisi.value = 1;
					document.frmData.waktu_pasang.value = "hari"; 
					getSelama(); */
				}else
				if(cek2=="12"){
					document.frmData.kode_rek1.value = "4.1.1.04.02";
					document.frmData.nama_rek1.value = "Reklame Kain";
				/* 	document.frmData.tarif.value = "1750";
					document.frmData.trf.value = "20";
					document.frmData.teks_reklame.value = "UMBUL-UMBUL";
					document.frmData.sisi.value = 1;
					document.frmData.waktu_pasang.value = "hari";
					getSelama(); */
				}else
				if(cek2=="13"){
					document.frmData.kode_rek1.value = "4.1.1.04.02";
					document.frmData.nama_rek1.value = "Reklame Kain";
				/* 	document.frmData.tarif.value = "2000";
					document.frmData.trf.value = "20";
					document.frmData.teks_reklame.value = "LAYAR TOKO";
					document.frmData.sisi.value = 1;
					document.frmData.waktu_pasang.value = "hari";
					getSelama(); */
				}else
				if(cek2=="14"){
					document.frmData.kode_rek1.value = "4.1.1.04.02";
					document.frmData.nama_rek1.value = "Reklame Kain";
				/* 	document.frmData.tarif.value = "2250";
					document.frmData.trf.value = "20";
					document.frmData.teks_reklame.value = "V. BANNER";
					document.frmData.sisi.value = 1;
					document.frmData.waktu_pasang.value = "hari";
					getSelama(); */
				}else
				...
				/* 	document.frmData.tarif.value = "5";
					document.frmData.trf.value = "20";
					document.frmData.teks_reklame.value = "STIKER"; */
				}else
				if(cek2=="7"){
					...
					/* document.frmData.tarif.value = "5";
					document.frmData.trf.value = "20";
					document.frmData.teks_reklame.value = "SELEBARAN"; */
				}else
				if(cek2=="8"){
			...
			/* 		document.frmData.tarif.value = "3000";
					document.frmData.trf.value = "20";
					document.frmData.teks_reklame.value = "BALON"; */
				}														
			}
			}						
		}
		...
		function ubahReklame(){
			...
			no_sptpd2 = document.frmData.sptpd_2.value;
			no_sptpd = no_sptpd + "|" + no_sptpd2.replace("/","|");
			/* masa_pajak_1 = document.frmData.tgl_ms_pajak1.value;
			masa_pajak_1 = masa_pajak_1.split("/");
			masa_pajak_1 = masa_pajak_1[2]+"-"+masa_pajak_1[1]+"-"+masa_pajak_1[0];
			masa_pajak_2 = document.frmData.tgl_ms_pajak2.value; */
			masa_pajak_2 = masa_pajak_2.split("/");
			masa_pajak_2 = masa_pajak_2[2]+"-"+masa_pajak_2[1]+"-"+masa_pajak_2[0];
			var win = window.open('../../pendataan/ubah_data_reklame/?no_sptpd='+no_sptpd+'&masa_pajak_1='+masa_pajak_1+'&masa_pajak_2='+masa_pajak_2,'_blank');
			win.focus();
		}
	...
	function get_kawasan(){
		...
		statusLoading();
		dhtmlxAjax.post(base_url+'index.php/pajaklain/kawasan', postJln, respJns);			
	}
	...
	function respJns(loader) {
		if (loader.xmlDoc.readyState == 4) {
			if (loader.xmlDoc.status == 200) {
				...
				if(result!=0) {
					a = result.split('/');
					document.frmData.kawasan.value = a[0];
					document.frmData.lebar.value = a[1];
	...
	function get_ketetapan(){
		...
		var postKet =
			//"gjenisrek=" + document.frmData.gjenisrek.value +			           
			"gjenisrek2=" + document.frmData.gjenisrek2.value +			           
			//"&waktu_pasang=" + document.frmData.waktu_pasang.value +			           
			//"&selama=" + document.frmData.selama.value +	 		
			"&kawasan=" + document.frmData.kawasan.value +			
			"&luas=" + document.frmData.luas.value +			
		/*	"&sisi=" + document.frmData.sisi.value +
		 	"&tinggi=" + document.frmData.tinggi.value +
			"&lebar=" + document.frmData.lebar.value +
			"&sudut=" + document.frmData.sudut.value + */
			//"&sifatp=" + document.frmData.sifatp.value +
			"&unt=" + document.frmData.unt.value;			
			//"&lokasi_pasang1=" + document.frmData.lokasi_pasang1.value;
		
		statusLoading();
		dhtmlxAjax.post(base_url+'index.php/pajaklain/pokok', postKet, respKet);			
	}
	
	function respKet(loader) {
		if (loader.xmlDoc.readyState == 4) {
			if (loader.xmlDoc.status == 200) {
				result = loader.xmlDoc.responseText;
				statusEnding();
				if(result!=0) {
					document.frmData.ketetapan.value = result;
	 ...
	 function crek_pajak() {
		var pil = document.frmData.gjenisrek2.value;   
		var postStr =
			"crek_pajak_rin=" + pil;  
		
		//statusLoading();
		//alert(postStr);
		dhtmlxAjax.post(base_url+'index.php/pajaklain/crek_pajak', postStr, wenePOST_rek);
	}
	...
	function wenePOST_rek(loader) {
		if (loader.xmlDoc.readyState == 4) {
			if (loader.xmlDoc.status == 200) {
				...
				if(result) {
					res = result.split('|');
					document.frmData.kode_rek1.value = res[0];
					document.frmData.nama_rek1.value = res[1];                                        
					statusEnding();
				}
			} else {
				 alert('There was a problem with the request.');
	...
	function crek_skpd() {
		var pil2 = document.frmData.nama_perusahaan.value;   
		var postStr =
			"skpd=" + pil2;  
		
		dhtmlxAjax.post(base_url+'index.php/pajaklain/crek_skpd', postStr, wenePOST_skpd);
	}

	function wenePOST_skpd(loader) {
		if (loader.xmlDoc.readyState == 4) {
			if (loader.xmlDoc.status == 200) {
				result = loader.xmlDoc.responseText;
				if(result) {
					kir = result.split('|');
					document.frmData.kd2.value = kir[0];                                        
					document.frmData.nm2.value = kir[1];                                        
					statusEnding();
				}
			} else {
				 alert('There was a problem with the request.');
