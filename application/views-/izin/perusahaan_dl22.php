...
<script language="javascript">
	...
	function lihat() {
		...
		statusLoading();
		dhtmlxAjax.post(base_url+'index.php/izin_dl2/lihat_pemilik', postStr, responeP);			
	}
	...
	function lihat2() {
		...
		grid.clearAll();
		grid.loadXML("<?php echo site_url(); ?>/izin_dl2/load_perusahaan/"+op+"/"+nilai,function() {
			statusEnding();
		});
	}
	...
	function simpan() {
		...
		/* if(document.frmPerusahaan.sptpd1.value==""){
			alert("Rekening Pajak Tidak Boleh Kosong");
		...
		var pemStr = 
			"id_pemilik=" + document.frmPerusahaan.id_pemilik.value;
		statusLoading();
		dhtmlxAjax.post(base_url+'index.php/izin_dl2/cek_pemilik', pemStr, pemPOST);
	}
...
//		}
		...
		dhtmlxAjax.post(base_url+'index.php/izin_dl2/simpan_perusahaan', postStr, responePOST);
	}
	...
	function ckelurahan() {
		var postStr =
			"kelurahan=" + document.frmPerusahaan.kelurahan.value;
		statusLoading();
		dhtmlxAjax.post(base_url+'index.php/izin_dl2/ckel', postStr, wenePOST);
	}
	...
	function ckecamatan() {
		...
		statusLoading();
		//alert(postStr);
		dhtmlxAjax.post(base_url+'index.php/izin_dl2/ckec', postStr, wenePOST);
	}
    ...
    function ckecamatan_pemilik() {
		...
		statusLoading();				
		dhtmlxAjax.post(base_url+'index.php/izin_dl2/ckec_2', postStr2, pemilikPOST);
	}
...
<div id="a_tabbar" style="width:1280px; height:810px; margin-left:30px;"></div>
  <div id="C1" style="width:1280px; background-color: #B3D9F0; padding-bottom:10px;"><br />
    <form name="frmPerusahaan" id="frmPerusahaan" action="<?php echo site_url(); ?>/izin_dl2/cetak_perusahaan" method="post" onSubmit="popupform(this, 'Perusahaan')">
    	<table>
		 <tr>
           ...
           <table>
            <tr>
              	<td width="170" style="padding-left:15px;">Desa</td>
            ...
            <tr>
              	<td style="padding-left:15px;">Kabupaten</td>
            ...
            <td>
               ...
               <table>
                <tr>
                    <td width="170" style="padding-left:15px;">Desa / Kelurahan</td>
            ...
            <tr>
             ...
             <tr>
              	<td style="padding-left:15px;"><strong>NPWPD Usaha</strong></td>
...
<script language="javascript">
	...
	function lihatPem() {
		...
		grids.clearAll();
		grids.loadXML("<?php echo site_url(); ?>/izin_dl2/load_pemilik/"+op+"/"+nilai,function() {
			statusEnding();
		});
	}
...
//		}
	...
	grid.loadXML("<?php echo site_url(); ?>/izin_dl2/data_perusahaan");
	grid.init();
	...
	function cetak1() {
		window.open('<?php echo site_url(); ?>/izin_dl2/cetak_peru?npwpd='+document.frmPerusahaan.id_perusahaan.value, '', 'height=700,width=1000,scrollbars=yes');
	}
	
	function cetak2() {
		window.open('<?php echo site_url(); ?>/izin_dl2/cetak_peru2?npwpd='+document.frmPerusahaan.id_perusahaan.value, '', 'height=700,width=1000,scrollbars=yes');
	}
	...
	function selectedOpenData(id) {
		...
		document.frmPerusahaan.id_perusahaan_lama.value = grid.cells(id,1).getValue();
			...
			if(enter=='dispenda'){
				...
				if(confrm) {
					var postStr =
						"id_perusahaan=" + document.frmPerusahaan.id_perusahaan.value;
						statusLoading();
						dhtmlxAjax.post('<?php echo site_url(); ?>/izin_dl2/delete_perusahaan', postStr, responeDel);			
				}
			} else {
