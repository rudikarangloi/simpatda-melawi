...
//		}
	...
	function enabledData() {
		...
		document.frmPerusahaan.id_perusahaan.disabled = false;
	...
	function disabledData() {
		document.frmPerusahaan.id_perusahaan.disabled = true;
...
<script language="javascript">
	...
	//grids.loadXML("<?//php echo site_url(); ?>/izin_dl2/data_pemilik");
	grids.init();
	baru();
	...
	function lihat21() {
		...
		gridData.clearAll();
		gridData.loadXML("<?php echo site_url(); ?>/izin_dl2/load_registrasi/"+op+"/"+nilai,function() {
			statusEnding();
		});
	}
...
//		}
	...
	function crek_pajak() {
		...
		statusLoading();
		//alert(postStr);
		dhtmlxAjax.post(base_url+'index.php/izin_dl2/crek_pajak', postStr, wenePOST_rek);
	} 
	...
	function cari2() {
		...
		grid.clearAll();
		grid.loadXML("<?php echo site_url(); ?>/izin_dl2/load_perusahaan_rek/"+pil);
