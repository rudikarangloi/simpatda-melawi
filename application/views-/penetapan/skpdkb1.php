...
<script language="javascript">
	...
	function lihat() {
		if(document.frmSKPDKB.nota.value=="") {
...
<h2 style="margin:30px 5px 25px 30px;">SKPDKB - <?php echo $title; ?></h2>
  ...
  <div id="C1" style="background-color: #B3D9F0">
    ...
    <br /><input type="hidden" name="kode" id="kode" value="<?php echo $kode; ?>" />
   	  <table width="870" border="0">
      		<tr>
        		<td width="234" style="padding-left:15px;">No. SKPDKB</td>
           	  	<td width="367">
            ...
            <tr>
                ...
                <td><input type="text" name="setoran" id="setoran" disabled/></td>
             </tr>
             <tr>
...
function cetak1() {
		...
		var gabung = dua+'/'+s;
		window.open('<?php echo site_url(); ?>/skpdkb/cetak?no_skpdkb='+gabung, '', 'height=700,width=1000,scrollbars=yes');
	}
