...
<table width="200" border="0">
	<tr>
    	<td colspan="4" align="center"><strong>Rekapitulasi Perhitungan Pajak</strong></td>
...
function getKelurahan(){
	...
	function preview() {	
		...
		window.open(base_url+"index.php/rekapitulasi/potensi/"+kec+"/"+kel,'width=500,height=400,scrollbars=1');
	}
	
	function toExcel(){
		var kec = z.getSelectedValue();
		var kel = z1.getSelectedValue();
		window.location = base_url+"index.php/rekapitulasi/toexcel/"+kec+"/"+kel,'Report','width=500,height=400';
	}
