...
<script language="javascript">
	...
	function simpan() {
		...
		var postStr =
			...
			"&pajak=" + pajak;
		statusLoading();
		dhtmlxAjax.post(base_url+'index.php/tegur_skpd3/simpan', postStr, responePOST);
	}
...
<h2 style="margin:30px 5px 25px 30px;">Surat Teguran II</h2>
    ...
    <form name="frmPengukuhan" id="frmPengukuhan">
    	<table border="0" id="tab_pengukuhan">
    		<tr>
                ...
                <td width="400"><input type="hidden" name="id" id="id" size="35px" style="text-transform:uppercase; background-color: #FFFFCC;" disabled="disabled"><input type="text" name="ukuh" id="ukuh" size="35px" style="text-transform:uppercase; background-color: #FFFFCC;" ></td>
            </tr>
			<tr>
			...
			<tr>
              	<td style="padding-left:15px;">Tanggal Surat Teguran I</td>
				<td><input type="text" name="tgl" id="tgl"  disabled="disabled" size="15px" style="background-color:#white;"/></td>
            </tr>
			<tr>
              	<td style="padding-left:15px;">Tanggal Surat Teguran II</td>
				<td><input type="text" name="tgl2" id="tgl2"  disabled="disabled" size="15px" style="background-color:#white;"/></td>
            </tr>
            <tr>
...
<script language="javascript">
	function cetakData(){
		...
		window.open('<?php echo site_url(); ?>/tegur_skpd3/cetak?npwpd='+document.frmPengukuhan.npwpd.value+'&tmbs_wali='+tmbs_wali+'&tmbs_insp='+tmbs_insp+'&tmbs_satpp='+tmbs_satpp, '', 'height=700,width=1000,scrollbars=yes');
	}
	...
	grid.setHeader("ID, No. Teguran, No Surat Teguran 1,Tanggal Surat Teguran 1,Tanggal Surat Teguran 2, NPWPD Perusahaan, Nama Perusahaan, Alamat Perusahaan, Kewajiban, Pemilik/Pimpinan, Tunggakan, Jenis_usaha");
	grid.setInitWidths("50,110,120,120,120,120,150,300,80,100,150,120");
	...
	grid.setColAlign("center,center,center,center,center,left,left,left,left,center,center,left");
	...
	grid.loadXML("<?php echo site_url(); ?>/tegur_skpd3/data");
	grid.init();
	...
	function selectedOpenData(id) {
		...
		enabledButton();
		//enabledData();
		var tunggakan = grid.cells(id,10).getValue();
		...
		document.frmPengukuhan.tgl.value = grid.cells(id,3).getValue();
		document.frmPengukuhan.tgl2.value = grid.cells(id,4).getValue();
		document.frmPengukuhan.npwpd.value = grid.cells(id,5).getValue();
		document.frmPengukuhan.nama.value = grid.cells(id,6).getValue();
		document.frmPengukuhan.alamat.value = grid.cells(id,7).getValue();
		menu = grid.cells(id,8).getValue();
        document.frmPengukuhan.usaha.value = grid.cells(id,9).getValue();
		document.frmPengukuhan.pemilik.value = grid.cells(id,9).getValue();
				...
				if(confrm) {					
						var postStr =
							...
							"&npwpd=" + document.frmPengukuhan.npwpd.value;		
								//alert(postStr);
							statusLoading();
							dhtmlxAjax.post(base_url+'index.php/tegur_skpd3/delete', postStr, responeDel);	
				}
			} else {
