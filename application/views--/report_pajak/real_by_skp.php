...
<title>Laporan SKP Belum Bayar</title>
</head>
...
<div align="center">
	<h2>Laporan SKPD<br/>Surat Ketetapan Pajak Daerah Belum Bayar</h2>
...
for($bln=1;$bln<=12;$bln++){
	...
	$sql = $this->db->query("SELECT DATE_FORMAT(skpd.tgl,'%d/%m/%Y') AS tgl, skpd.no_skpd, view_perusahaan.nama_perusahaan, view_perusahaan.alamat_perusahaan, view_perusahaan.npwpd_perusahaan, skpd.jumlah, DATE_FORMAT(skpd.tgl_jth_tempo,'%d/%m/%Y') AS tempo, skpd.masa_pajak1, skpd.masa_pajak2, skpd.tahun FROM view_perusahaan 
INNER JOIN skpd ON view_perusahaan.npwpd_perusahaan = skpd.npwpd 
WHERE skpd.status = '0' AND skpd.no_skpd NOT IN (SELECT npwpd FROM sptpd WHERE tanggal LIKE '%".$bln."%' AND tahun = '".$thn."')");
...
?>
	<tr style="color:#00F;">
		<td align="center"><?php echo $rs->no_skpd; ?></td>
