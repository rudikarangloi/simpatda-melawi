...
<form name="frmSrc" id="frmSrc" method="post" action="javascript:void(0);"><table width="590" border="0">
	...
	<tr>
        ...
        <td colspan="2"><input type="text" name="htgl_tempo" id="htgl_tempo" value="<?php echo $tgl2; ?>" style="background-color:#FFCC99;" /></td>
	...
	<tr>
		<td style="padding-left:15px; border-bottom:3px solid black;">Tanggal Ketetapan</td>
    ...
    <tr>
		<td style="padding-left:15px;">Omset</td>
...
<script language="javascript">
	...
	gride.setHeader("Kode Rekening, Nama Rekening, Omset, Tarif, Kenaikan, Denda, Kompensasi, Bunga, Jumlah, SPTPD, No Nota");
