...
<script language="javascript">
	...
	function simpan_perusahaan(){
		...
		var postStr =
			...
			"&nama_perusahaan=" + document.frmPerusahaan.nama_perusahaan.value +
			...
			"&kecamatan=" + document.frmPerusahaan.kecamatan.value +
			...
			"&jenis_usaha=" + document.frmPerusahaan.jenis_usaha.value +
	...
	function kosongfrmPerusahaan() {
		...
		document.frmPerusahaan.kecamatan.value = "";
		...
		document.frmPerusahaan.jenis_usaha.value = "";
		...
		document.frmPerusahaan.jenis_pajak.value = "";
	...
	function enabledData() {
		...
		document.frmPerusahaan.jenis_usaha.disabled = false;
	...
	function disabledData() {
		...
		document.frmPerusahaan.jenis_usaha.disabled = true;
...
<h2 style="margin:30px 5px 25px 30px;">Pendaftaran Perusahaan</h2>

<div id="a_tabbar" style="width:1000px; height:1020px; margin-left:30px;"></div>
  <div id="C1" style="background-color: #B3D9F0; padding-bottom:10px;"><br />
    <form name="frmPerusahaan" id="frmPerusahaan" action="<?php echo site_url(); ?>/izin/cetak_perusahaan" method="post" onSubmit="popupform(this, 'Perusahaan')">
    	<table>
            <tr>
                <td width="250" style="padding-left:15px;"><strong>NPWPD Perusahaan</strong></td>
            ...
            <tr>
                ...
                <td><select name="kelurahan" id="kelurahan" onchange="ckelurahan();" disabled>
                <option value=""></option>
                <?php 
            ...
            <tr>
                ...
                <td><input type="hidden" name="kecamatan" id="kecamatan" size="4" disabled="disabled" />                  <input type="text" name="nm_kec" id="nm_kec" size="45" disabled="disabled"></td>
            </tr>
            <tr>
              	<td style="padding-left:35px;">Kabupaten / Kota</td>
                <td><input type="text" name="kabupaten" id="kabupaten" value="KOTA PADANG" size="45" disabled="disabled" style="background-color:#FFFFCC;" /></td>
            </tr>
            <tr>
           ...
           <table>
            ...
            <tr>
                ...
                <td><input type="text" name="kecamatan_p" id="kecamatan_p" size="45" disabled="disabled"></td>
            </tr>
            <tr>
              	<td style="padding-left:15px;">Kabupaten / Kota</td>
                <td><input type="text" name="kabupaten_p" id="kabupaten_p" value="KOTA PADANG" size="45" style="background-color:#FFFFCC;" disabled="disabled" /></td>
            </tr>
            </table>
            </fieldset>
            </td>
            ...
            <tr>
                ...
                <td><select id="jenis_usaha" class="jenis_usaha" disabled>
                <option value=""></option>
				<?php 
            ...
            <tr>
				...
				<td><input type="text" name="kategori" id="kategori" disabled="disabled" size="45"/></td>
            </tr>
            <tr>
            ...
            <tr>
				...
				<td>
					<select name="jenis_pajak" disabled="disabled" id="jenis_pajak" onchange="pilih()">
						...
						<option value="9">Air Bawah Tanah</option>
					</select>
				</td>
            </tr>
            <tr>
            ...
            <tr>
            	<td style="padding-left:15px;" colspan="2"><input type="button" value="Open Data Register" id="reg" name="reg" onclick="openData()" style="padding-left:20px; padding-right:20px" /><input type="button" value="Baru" id="new1" name="new1" onclick="baru()" style="padding-left:20px; padding-right:20px" />
...
<br />
    ...
    <table>
    	<tr>
            ...
            <option value="1">ID Perusahaan</option>
            <option value="2">ID Pemilik</option>
    ...
    <div style="padding:0 75px 0 15px;">
   		<div id="gridContent" height="270px" style="margin-bottom:10px;"></div>
  	...
  	<tr>
		<td style="padding-left:15px;">Cari data berdasarkan 
      	<select name="fil" id="fil" >
            ...
            <option value="3">NPWPD Pemilik</option>
...
<script language="javascript">
	...
	//Window Pemilik
	wPem21 = dhxWins.createWindow("wPem21",0,0,800,370);
	...
	grids.setHeader("ID, ID_Pemilik, Jenis Identitas, Kewarganegaraan, No.Identitas, Nama, Alamat, Jalan, RT, RW, Email, Kelurahan, Kecamatan, Kabupaten, Tempat Lahir, Tanggal Lahir,Jenis Kelamin,Lokasi,HP");//19
	...
	grids.setInitWidths("50,100,150,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100");
	grids.setColAlign("center,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left");
	grids.setColTypes("ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro");
	grids.setColSorting("str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str");
	grids.enablePaging(true,10,10,"pagingArea",true);
	...
	function selectedOpenData2(id) {
		...
		if(document.frmPerusahaan.lokasi_p.value=='1'){
			document.frmPerusahaan.kelurahan_p.value = grids.cells(id,11).getValue();
	...
	gridData.setHeader("id, no_daftar, nama_perusahaan, alamat_perusahaan, jalan, rt, rw, email, kelurahan, kecamatan, kabupaten, telp, kodepos, npwpd_pemilik, nama_pemilik, alamat_pemilik, jalan_pemilik, rt_pemilik, rw_pemilik, email_pemilik, lokasi_pemilik, kelurahan_pemilik, kecamatan_pemilik, kabupaten_pemilik, telp_pemilik, kodepos_pemilik, jenis_usaha, status_usaha, kategori, jml_karyawan, ukuran_tempat, surat_izin, no_surat, tgl_surat, jenis_pajak, jenis_pajak_detail, tgl_daftar");//36
	gridData.setInitWidths("50,100,150,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,150,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100");//19
	gridData.setColAlign("center,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left");
	gridData.setColTypes("ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro");
	gridData.setColSorting("str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str");
	...
	function selectedOpenData21(id) {
		...
		document.frmPerusahaan.kecamatan.value = gridData.cells(id,9).getValue();
		document.frmPerusahaan.kabupaten.value = gridData.cells(id,10).getValue();
		document.frmPerusahaan.tlp.value = gridData.cells(id,11).getValue();
		document.frmPerusahaan.kodepos.value = gridData.cells(id,12).getValue();
		document.frmPerusahaan.id_pemilik.value = gridData.cells(id,13).getValue();
		document.frmPerusahaan.nama_p.value = gridData.cells(id,14).getValue();
		document.frmPerusahaan.alamat_p.value = gridData.cells(id,15).getValue();
		document.frmPerusahaan.jalan_p.value = gridData.cells(id,16).getValue();
		document.frmPerusahaan.rt_p.value = gridData.cells(id,17).getValue();
		document.frmPerusahaan.rw_p.value = gridData.cells(id,18).getValue();
		document.frmPerusahaan.email_p.value = gridData.cells(id,19).getValue();
		
		document.frmPerusahaan.lokasi_p.value = gridData.cells(id,20).getValue();
		if(document.frmPerusahaan.lokasi_p.value=='1'){
			document.frmPerusahaan.kelurahan_p.value = gridData.cells(id,21).getValue();
			document.frmPerusahaan.kecamatan_p.value = gridData.cells(id,22).getValue();
			document.frmPerusahaan.kabupaten_p.value = gridData.cells(id,23).getValue();
		} else if(document.frmPerusahaan.lokasi_p.value=='2'){
			document.frmPerusahaan.kelurahan_p1.value = gridData.cells(id,21).getValue();
			document.frmPerusahaan.kecamatan_p1.value = gridData.cells(id,22).getValue();
			document.frmPerusahaan.kabupaten_p1.value = gridData.cells(id,23).getValue();
		}
		document.frmPerusahaan.tlp_p.value = gridData.cells(id,24).getValue();
		document.frmPerusahaan.kodepos_p.value = gridData.cells(id,25).getValue();
		document.frmPerusahaan.jenis_usaha.value = gridData.cells(id,26).getValue();
		document.frmPerusahaan.status.value = gridData.cells(id,27).getValue();
		document.frmPerusahaan.kategori.value = gridData.cells(id,28).getValue();
		document.frmPerusahaan.jml_karyawan.value = gridData.cells(id,29).getValue();
		document.frmPerusahaan.ukuran_tempat.value = gridData.cells(id,30).getValue();
		document.frmPerusahaan.izin.value = gridData.cells(id,31).getValue();
		document.frmPerusahaan.nomor.value = gridData.cells(id,32).getValue();
		document.frmPerusahaan.tanggal.value = gridData.cells(id,33).getValue();
		document.frmPerusahaan.jenis_pajak.value = gridData.cells(id,34).getValue();
		jp = gridData.cells(id,34).getValue();
		if(jp=='1'||jp=='2'||jp=='3'||jp=='4'||jp=='5'||jp=='6'||jp=='7'||jp=='8'){
			document.frmPerusahaan.omset.value = gridData.cells(id,35).getValue();
		} else if (jp=='9'){
			document.frmPerusahaan.air_tanah.value = gridData.cells(id,35).getValue();
		}
		document.frmPerusahaan.tgl.value = gridData.cells(id,36).getValue();
	...
	function pilih(){
		pil=document.getElementById("jenis_pajak").value;
		//alert(pil);
	...
	grid.setHeader("id, NPWPD Perusahaan, nama_perusahaan, alamat_perusahaan, jalan, rt, rw, email, kelurahan, kecamatan, kabupaten, telp, kodepos, npwpd_pemilik, nama_pemilik, alamat_pemilik, jalan_pemilik, rt_pemilik, rw_pemilik, email_pemilik, lokasi_pemilik, kelurahan_pemilik, kecamatan_pemilik, kabupaten_pemilik, telp_pemilik, kodepos_pemilik, jenis_usaha, status_usaha, kategori, jml_karyawan, ukuran_tempat, surat_izin, no_surat, tgl_surat, jenis_pajak, jenis_pajak_detail, tgl_daftar,kode_kec");//36
	grid.setInitWidths("50,100,150,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,150,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100");//19
	grid.setColAlign("center,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left");
	grid.setColTypes("ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro");
	grid.setColSorting("str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str");
	...
	function cetak1() {
		window.open('<?php echo site_url(); ?>/izin/cetak_perusahaan?npwpd='+document.frmPerusahaan.id_perusahaan.value, '', 'height=700,width=1000,scrollbars=yes');
	}
	...
	function selectedOpenData(id) {
		...
		document.frmPerusahaan.nama_perusahaan.value = grid.cells(id,2).getValue();
		document.frmPerusahaan.alamat_perusahaan.value = grid.cells(id,3).getValue();
		...
		document.frmPerusahaan.kelurahan.value = grid.cells(id,8).getValue();
		document.frmPerusahaan.nm_kec.value = grid.cells(id,9).getValue();
		document.frmPerusahaan.kecamatan.value = grid.cells(id,37).getValue();
		document.frmPerusahaan.kabupaten.value = grid.cells(id,10).getValue();
		document.frmPerusahaan.tlp.value = grid.cells(id,11).getValue();
		document.frmPerusahaan.kodepos.value = grid.cells(id,12).getValue();
		document.frmPerusahaan.id_pemilik.value = grid.cells(id,13).getValue();
		document.frmPerusahaan.nama_p.value = grid.cells(id,14).getValue();
		document.frmPerusahaan.alamat_p.value = grid.cells(id,15).getValue();
		document.frmPerusahaan.jalan_p.value = grid.cells(id,16).getValue();
		document.frmPerusahaan.rt_p.value = grid.cells(id,17).getValue();
		document.frmPerusahaan.rw_p.value = grid.cells(id,18).getValue();
		document.frmPerusahaan.email_p.value = grid.cells(id,19).getValue();
		
		document.frmPerusahaan.lokasi_p.value = grid.cells(id,20).getValue();
		if(document.frmPerusahaan.lokasi_p.value=='1'){
			document.frmPerusahaan.kelurahan_p.value = grid.cells(id,21).getValue();
			document.frmPerusahaan.kecamatan_p.value = grid.cells(id,22).getValue();
			document.frmPerusahaan.kabupaten_p.value = grid.cells(id,23).getValue();
		} else if(document.frmPerusahaan.lokasi_p.value=='2'){
			document.frmPerusahaan.kelurahan_p1.value = grid.cells(id,21).getValue();
			document.frmPerusahaan.kecamatan_p1.value = grid.cells(id,22).getValue();
			document.frmPerusahaan.kabupaten_p1.value = grid.cells(id,23).getValue();
		}
		document.frmPerusahaan.tlp_p.value = grid.cells(id,24).getValue();
		document.frmPerusahaan.kodepos_p.value = grid.cells(id,25).getValue();
		document.frmPerusahaan.jenis_usaha.value = grid.cells(id,26).getValue();
		document.frmPerusahaan.status.value = grid.cells(id,27).getValue();
		document.frmPerusahaan.kategori.value = grid.cells(id,28).getValue();
		document.frmPerusahaan.jml_karyawan.value = grid.cells(id,29).getValue();
		document.frmPerusahaan.ukuran_tempat.value = grid.cells(id,30).getValue();
		document.frmPerusahaan.izin.value = grid.cells(id,31).getValue();
		document.frmPerusahaan.nomor.value = grid.cells(id,32).getValue();
		document.frmPerusahaan.tanggal.value = grid.cells(id,33).getValue();
		document.frmPerusahaan.jenis_pajak.value = grid.cells(id,34).getValue();
		jp = grid.cells(id,34).getValue();
		if(jp=='1'||jp=='2'||jp=='3'||jp=='4'||jp=='5'||jp=='6'||jp=='7'||jp=='8'){
			document.frmPerusahaan.omset.value = grid.cells(id,35).getValue();
		} else if (jp=='9'){
			document.frmPerusahaan.air_tanah.value = grid.cells(id,35).getValue();
		}
		document.frmPerusahaan.tgl.value = grid.cells(id,36).getValue();
		statusEnding();
	}
