...
<div id="a_tabbar" style="width:1000px; height:1040px; margin-left:30px;"></div>
  <div id="C1" style="width:1000px; background-color: #B3D9F0; padding-bottom:10px;"><br />
    <form name="frmPerusahaan" id="frmPerusahaan" action="<?php echo site_url(); ?>/izin/cetak_perusahaan" method="post" onSubmit="popupform(this, 'Perusahaan')">
    	<table>
            ...
            <tr>
                ...
                <td><select name="kelurahan" id="kelurahan" onchange="ckecamatan();" disabled>
                <option value=""></option>
                <?php 
            ...
            <tr>
				...
				<td>
					<select name="jenis_pajak" disabled="disabled" id="jenis_pajak" onchange="pilih()">
						...
						<option value="5">Mineral Bukan Logam dan Batuan</option>
						<option value="6">Parkir</option>
						<option value="7">Burung Walet</option>
						<option value="8">Air Bawah Tanah</option>
                        <option value="9">Penerangan Jalan</option>
					</select>
				</td>
            </tr>
            <tr>
...
<br />
    ...
    <div style="padding:0 0px 10px 0px;">
   		<div id="gridContent" height="895px" width="995px" style="margin-bottom:10px;"></div>
...
<script language="javascript">
	...
	gridData.setHeader("id, no_daftar, nama_perusahaan, alamat_perusahaan, jalan, rt, rw, email, kelurahan, nama_kelurahan, kecamatan, nama_kecamatan, kabupaten, telp, kodepos, npwpd_pemilik, nama_pemilik, alamat_pemilik, jalan_pemilik, rt_pemilik, rw_pemilik, email_pemilik, lokasi_pemilik, kelurahan_pemilik, kecamatan_pemilik, kabupaten_pemilik, telp_pemilik, kodepos_pemilik, jenis_usaha, status_usaha, kategori, jml_karyawan, ukuran_tempat, surat_izin, no_surat, tgl_surat, jenis_pajak, jenis_pajak_detail, tgl_daftar");//36
	gridData.setInitWidths("50,100,150,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,150,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100");//19
	gridData.setColAlign("center,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left");
	gridData.setColTypes("ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro");
	gridData.setColSorting("str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str");
	...
	function selectedOpenData21(id) {
		...
		document.frmPerusahaan.kecamatan2.value = gridData.cells(id,11).getValue();
		
		document.frmPerusahaan.nm_kec.value = gridData.cells(id,10).getValue();
		...
		document.frmPerusahaan.lokasi_p.value = gridData.cells(id,22).getValue();
		if(document.frmPerusahaan.lokasi_p.value=='1'){
			document.frmPerusahaan.kelurahan_p.value = gridData.cells(id,23).getValue();
			document.frmPerusahaan.kecamatan_p.value = gridData.cells(id,24).getValue();
			document.frmPerusahaan.kabupaten_p.value = gridData.cells(id,25).getValue();
		} else if(document.frmPerusahaan.lokasi_p.value=='2'){
			document.frmPerusahaan.kelurahan_p1.value = gridData.cells(id,23).getValue();
			document.frmPerusahaan.kecamatan_p1.value = gridData.cells(id,24).getValue();
			document.frmPerusahaan.kabupaten_p1.value = gridData.cells(id,25).getValue();
		}
		document.frmPerusahaan.tlp_p.value = gridData.cells(id,26).getValue();
		document.frmPerusahaan.kodepos_p.value = gridData.cells(id,27).getValue();
		document.frmPerusahaan.jenis_usaha.value = gridData.cells(id,28).getValue();
		document.frmPerusahaan.status.value = gridData.cells(id,29).getValue();
		document.frmPerusahaan.kategori.value = gridData.cells(id,30).getValue();
		document.frmPerusahaan.jml_karyawan.value = gridData.cells(id,31).getValue();
		document.frmPerusahaan.ukuran_tempat.value = gridData.cells(id,32).getValue();
		document.frmPerusahaan.izin.value = gridData.cells(id,33).getValue();
		document.frmPerusahaan.nomor.value = gridData.cells(id,34).getValue();
		document.frmPerusahaan.tanggal.value = gridData.cells(id,35).getValue();
		document.frmPerusahaan.jenis_pajak.value = gridData.cells(id,36).getValue();
	...
	grid.setHeader("id, NPWPD Perusahaan, nama_perusahaan, alamat_perusahaan, jalan, rt, rw, email, kelurahan, nama_kelurahan, kecamatan, nama_kecamatan, kabupaten, telp, kodepos, npwpd_pemilik, nama_pemilik, alamat_pemilik, jalan_pemilik, rt_pemilik, rw_pemilik, email_pemilik, lokasi_pemilik, kelurahan_pemilik, kecamatan_pemilik, kabupaten_pemilik, telp_pemilik, kodepos_pemilik, jenis_usaha, status_usaha, kategori, jml_karyawan, ukuran_tempat, surat_izin, no_surat, tgl_surat, jenis_pajak, jenis_pajak_detail, tgl_daftar");//36
	grid.setInitWidths("50,150,150,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,150,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100");//19
	grid.setColAlign("center,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left");
	grid.setColTypes("ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro");
	grid.setColSorting("str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str");
	grid.enablePaging(true,40,10,"pagingArea",true);
	...
	function selectedOpenData(id) {
		...
		if(document.frmPerusahaan.lokasi_p.value=='1'){
			document.frmPerusahaan.kelurahan_p.value = grid.cells(id,23).getValue();
		...
		document.frmPerusahaan.jenis_usaha.value = grid.cells(id,28).getValue();
		document.frmPerusahaan.status.value = grid.cells(id,29).getValue();
		document.frmPerusahaan.kategori.value = grid.cells(id,30).getValue();
