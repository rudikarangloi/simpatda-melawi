...
<h2 style="margin:30px 5px 25px 30px;">Master Data Desa</h2>
<div class="oval_big2">

<div id="topnav" style="width: auto;"></div>
<div id="gridboxfrmData" style="width:500px; height:550px;"></div><br>
...
<script language="javascript">
	...
	gridfrmData.setHeader("ID, Kode Desa, Nama Desa, Kode Kecamatan");
	gridfrmData.setInitWidths("90,100,150,100")
	gridfrmData.setColAlign("left,left,left,left")
	gridfrmData.setColTypes("ed,ed,ed,ed");
	gridfrmData.enableMultiselect(true);
	gridfrmData.init();
	gridfrmData.setSkin("dhx_skyblue");
	gridfrmData.loadXML("<?php echo site_url(); ?>/master_setting/data_kelurahan");
	initDP();

	var dpps = "";
	function initDP() {
		dpps = new dataProcessor("<?php echo site_url(); ?>/master_setting/data_kelurahan");
