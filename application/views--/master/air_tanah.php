...
<script language="javascript">
	...
	function addRowList() {
		...
		var row4= '';
		var row5= '';
		gridfrmData.addRow(id,[row1,row2,row3,row4,row5],posisi);
...
<h2 style="margin:30px 5px 25px 30px;">Tarif Air Tanah</h2>
<div class="oval_big2">

<div id="topnav" style="width: auto;"></div>
<div id="gridboxfrmData" style="width:500px; height:400px;"></div><br />
<input type="button" value="Tambah" onclick="addRowList()" />
<input type="button" value="Hapus" onclick="deleterowsfrmData()" />
</div>

<h3>Ket :</h3>
<p>- Lokasi : 1 = Dalam Jangkauan PDAM, 2 = Diluar Jangkauan PDAM.</p>
<p>- Tujuan : 1 = Non Niaga, 2 = Niaga Kecil, 3 = Industri Kecil, 4 = Niaga Besar, 5 = Industri Besar.</p>
<p>- Volume : 1 = 0-50 m<sup>3</sup>, 2 = 51-500 m<sup>3</sup>, 3 = 501-1000 m<sup>3</sup>, 4 = 1001-2500 m<sup>3</sup>, 5 = 2501-3000 m<sup>3</sup></p>  
<script language="javascript">
	gridfrmData = new dhtmlXGridObject('gridboxfrmData');
	gridfrmData.setImagePath("<?php echo base_url(); ?>/assets/codebase_grid/imgs/");
	gridfrmData.setHeader("Lokasi, Tujuan, Volume, Tarif");
	gridfrmData.setInitWidths("100,100,100,100")
	gridfrmData.setColAlign("center,center,center,center")
	gridfrmData.setColTypes("ed,ed,ed,ed");
	gridfrmData.enableMultiselect(true);
	gridfrmData.init();
	gridfrmData.setSkin("dhx_skyblue");
	gridfrmData.loadXML("<?php echo site_url(); ?>/master_setting/data_air");
	initDP();

	var dpps = "";
	function initDP() {
		dpps = new dataProcessor("<?php echo site_url(); ?>/master_setting/data_air");
