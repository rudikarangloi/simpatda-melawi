...
<script language="javascript">
	...
	function deleterowsfrmData() {
		ya = confirm("Yakin akan hapus data ini ?");
		if(ya) {
...
<h2 style="margin:30px 5px 25px 30px;">Tarif Retribusi</h2>
<div class="oval_big2">

<div id="topnav" style="width: auto;"></div>
<div id="gridboxfrmData" style="width:500px; height:365px;"></div><br />
<footer>Apabila luas lebih dari 100 m<sup>2</sup>, maka akan dikalikan dengan Rp. 1.750 /m<sup>2</sup></footer><br />
...
<script language="javascript">
	...
	gridfrmData.setHeader("Id,Uraian Skema Luas Tempat Usaha, Tarif");
	gridfrmData.setInitWidths("50,300,150")
	gridfrmData.setColAlign("center,left,right")
	gridfrmData.setColTypes("ed,ed,ron");
	gridfrmData.enableMultiselect(true);
    gridfrmData.setNumberFormat("0,000",2,",",".");
	gridfrmData.init();
	gridfrmData.setSkin("dhx_skyblue");
	gridfrmData.loadXML("<?php echo site_url(); ?>/master_setting/data_tarif_retribusi");
	initDP();

	var dpps = "";
	function initDP() {
		dpps = new dataProcessor("<?php echo site_url(); ?>/master_setting/data_tarif_retribusi");
