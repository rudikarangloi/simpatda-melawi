...
//		+kata_kunci+"/"+document.frmSrc4.parameter.value
	...
	gridDatas.setHeader("id,No SSPD,Dasar Setoran,Pembayaran,Tanggal,No SKPD,NPWPD,Nama Usaha,Alamat Usaha,Nama Pemilik,Alamat Pemilik,Masa Pajak 1,Masa Pajak 2,Tahun Pajak,Keterangan,Ketetapan,Setoran,Persen,Created,Modified,User Created,User Modified,Nota Hitung,Denda,ms1,ms2,ttd");
