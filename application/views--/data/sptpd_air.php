...
<div id="a_tabbar" style="width:1000px; height:620px; margin-left:30px;"></div>
  <div id="C1" style="background-color: #B3D9F0">
			<form name="frmData" id="frmData" method="post">
				...
				<table>
					<tr>
						<td width="200" style="padding-left:15px;">No SPTPD</td>
						<td><input type="text" name="txtnosptpd_a" id="txtnosptpd_a" size="20" maxlength=10  style="background-color:#FFFFCC;" />&nbsp;<input type="text" name="txtnosptpd_b" id="txtnosptpd_b" size="10" style="background-color:#FFFFCC;" /></td>
					</tr>
					<tr>
						<td width="200" style="padding-left:15px;">Masa Pajak</td>
						<td><?php echo $ctl_masapajak1; ?> s.d <?php echo $ctl_masapajak2; ?></td>
					</tr>
					<tr>
						<td width="200" style="padding-left:15px;">Tahun Pajak</td>
					...
					<tr>
						<td width="200" style="padding-left:15px;">Diterima Tanggal</td>
						<td><input type="text" name="txttglditerima" id="txttglditerima" size="12" /></td>
					</tr>
					<tr>
						<td width="200" style="padding-left:15px;">&nbsp;&nbsp;&nbsp;Petugas Input</td>
					...
					<tr>
						...
						<td nowrap><input type="text" name="txtvolume" id="txtvolume" size="8" style="text-align:right"/> M<sup>3</sup>&nbsp;<input type="button" onclick="hitung_tarif();" value="Hitung" name="hit" id="hit" disabled/></td>
					</tr>
					<tr>
						<td nowrap style="padding-left:15px;" valign="top">Total Harga Dasar</td>
						<td nowrap>Rp. <input type="text" name="txthargadasar" id="txthargadasar" size="8" value="0" disabled="disabled" readonly style="text-align:right"/></sup> </td>
					</tr>
					<tr>
						<td colspan=2><b><i><u>Data Masa Pajak Air Tanah & Dasar Pengenaan</u></i></b></td>
					</tr>
					<tr>
						<td style="padding-left:15px;" valign="top">&nbsp;&nbsp;a. Masa Pajak</td>
						<td><input type="text" name="txttglmasapajak1" id="txttglmasapajak1" size="12" disabled="disabled"/>&nbsp;
			 <i>s.d</i> <input type="text" name="txttglmasapajak2" id="txttglmasapajak2" size="12" disabled="disabled"/>&nbsp;
		</td>
					</tr>
					<!--<tr>
                    ...
                    <tr>
						<td nowrap style="padding-left:15px;" valign="top">&nbsp;&nbsp;b. Tarif Pajak</td>
                    ...
                    <tr>
						<td nowrap style="padding-left:15px;" valign="top">&nbsp;&nbsp;c. Pajak Terhutang</td>
	...
	*/
	...
	function hitung_tarif(){
		if(document.frmData.txtnpwpd.value==""){
			alert("No. NPWPD Tidak Boleh Kosong");
		...
		var postAir = 
			...
			"tujuanpemanfaatan=" + document.frmData.txttujuanpemanfaatan.value + 
			"&kualitasair=" + document.frmData.txtkualitasair.value + 
		...
		if (loader.xmlDoc.readyState == 4) {
			if (loader.xmlDoc.status == 200) {
				...
				if(result){
					...
					document.frmData.txtpajakterutang.value = format_number(b[1]);
					statusEnding();
					return true;
				}
			} else {
	...
	grid.attachHeader("#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter");
	...
	grid.enablePaging(true,30,10,"pagingArea",true);
	...
	function addNew() {
		document.frmData.hit.disabled=false;
...
*/		
	...
	function cek(){
		...
		statusLoading();
		dhtmlxAjax.post(base_url+'index.php/sptpd_air_bawah_tanah/ricek', postCek, resPOST);
	}
	...
	function simpan2(){
		...
		document.frmData.hit.disabled=true;
		document.frmData.btnaddnew.disabled=false;
		document.frmData.btnsimpan.disabled=true;
		document.frmData.btnedit.disabled=false;
		document.frmData.btndel.disabled=false;
