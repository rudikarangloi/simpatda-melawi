...
<h2 style="margin:30px 5px 25px 30px;">SPTPD Hotel ( Bank )</h2>
...
<div id="a_tabbar" style="width:1000px; height:530px; margin-left:30px;"></div>
  <div id="C1" style="background-color: #B3D9F0">
    ...
    <br />
   	  <table width="787" border="0">
            ...
            <tr>
                ...
                <td colspan="2"><input type="text" name="tgl" id="tgl" size="45" disabled/></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="2"><input style="text-align:right" type="text" name="jumlah" id="jumlah" size="22" onkeyup="hitung();" disabled/></td>
            </tr>
            <tr>
	...
	<tr>
       	<td style="padding-left:15px; background-color:#FFCC99;"><input type="button" value="Baru" onclick="baru()" name="baru1" style="padding-left:20px; padding-right:20px"/>&nbsp;&nbsp;<input type="button" value="Simpan" onclick="simpan()" name="tambah" style="padding-left:20px; padding-right:20px" disabled/></td>
        <td colspan="2" style="background-color:#FFCC99;"><!--<input type="button" value="Edit" onclick="ubah()" name="edit1" style="padding-left:20px; padding-right:20px" disabled/>
...
<script language="javascript">
	...
	function lihat3() {
		...
		gridx.clearAll();
		gridx.loadXML("<?php echo site_url(); ?>/hotel/load_perusahaan/"+op+"/"+nilai,function() {
			statusEnding();
		});
	}
	...
	grid.setHeader("id, npwpd, no_sptpd, nama_perusahaan, alamat, jns, ket_insidentil, cara_hitung, tgl_terima, petugas, gol_hotel, masa_pajak1, masa_pajak2, omset, jml_bayar,tarif");
	...
	grid.setColTypes("ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ron,ron,ron");
	...
	grid.loadXML("<?php echo site_url(); ?>/hotel/data_bank");
	grid.init();
