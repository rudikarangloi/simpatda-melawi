...
<h2 style="margin:30px 5px 25px 30px;">SPTPD Pajak Hiburan</h2>
...
<script language="javascript">
	...
	grid.setHeader("id, no_sptpd, npwpd, nama_perusahaan, alamat, jenis_pajak, ket_insidentil, cara_hitung, tgl_diterima, jenis_hiburan, jml_biasa, jml_libur, rata2_biasa, rata2_libur, jml_meja_mesin, jml_ruangan, karcis_bebas, jml_karcis, mesin_tiket, pembukuan, masa_pajak1, masa_pajak2, jml_bayar, author, created, modified, petugas_input,omset, tarif",null,["text-align:center","text-align:center","text-align:center","text-align:center"]);//29
	grid.attachHeader("#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter");
	...
	grid.loadXML("<?php echo site_url(); ?>/sptpd_hiburan/data_sptpd");
	grid.init();
