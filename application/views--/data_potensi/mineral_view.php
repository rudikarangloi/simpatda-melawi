...
if($type=='excel'):
	...
	header('Content-Disposition: attachment; filename=data_potensi_mineral_bukan_logam.xls');	
endif;
?>
...
<p align="center"><strong>MINERAL BUKAN LOGAM DAN BATUAN</strong></p>
<table width="1255" border="1" cellspacing="3" cellpadding="3" class="style_border">
  <tr>
    ...
    <td bgcolor="#99CCFF"><div align="center">VOLUME</div></td>
...
LEFT JOIN (SELECT z.kode_kelurahan,z.nama_kelurahan,z.kode_kecamatan,x.nama_kecamatan FROM kelurahan z LEFT JOIN kecamatan x ON z.kode_kecamatan=x.kode_kecamatan) d ON b.kelurahan=d.kode_kelurahan AND b.kecamatan=d.kode_kecamatan		
  ...
  <tr>
    ...
    <td align="center" style="background-color:<?php echo $bg; ?>"><?php echo $r->volume ?></td>
    <td align="right" style="background-color:<?php echo $bg; ?>"><?php echo $r->tarif ?></td>
