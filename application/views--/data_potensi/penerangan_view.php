...
if($type=='excel'):
	...
	header('Content-Disposition: attachment; filename=data_potensi_penerangan_jalan.xls');	
endif;
?>
...
<p align="center"><strong>PENERANGAN JALAN</strong></p>
<table width="1255" border="1" cellspacing="3" cellpadding="3" class="style_border">
  <tr>
    ...
    <td bgcolor="#99CCFF"><div align="center">JENIS PENERANGAN</div></td>
    <td bgcolor="#99CCFF"><div align="center" style="width:80px">DAYA</div></td>
    <td bgcolor="#99CCFF"><div align="center">RATA2 PAKAI</div></td>
    <td bgcolor="#99CCFF"><div align="center">RATA2 OMSET</div></td>
    <td bgcolor="#99CCFF"><div align="center" style="width:150px">KETERANGAN</div></td>    
  </tr>
...
LEFT JOIN (SELECT z.kode_kelurahan,z.nama_kelurahan,z.kode_kecamatan,x.nama_kecamatan FROM kelurahan z LEFT JOIN kecamatan x ON z.kode_kecamatan=x.kode_kecamatan) d ON b.kelurahan=d.kode_kelurahan AND b.kecamatan=d.kode_kecamatan		
  ...
  <tr>
    ...
    <td align="center" style="background-color:<?php echo $bg; ?>"><?php echo $r->jenis_penerangan ?></td>
    <td align="center" style="background-color:<?php echo $bg; ?>"><?php echo $r->daya ?></td>
	<td align="right" style="background-color:<?php echo $bg; ?>"><?php echo $this->msistem->format_angka($r->rata2_pakai) ?></td>
    <td align="right" style="background-color:<?php echo $bg; ?>"><?php echo $this->msistem->format_angka($r->rata2_omset) ?></td>
  ...
  <tr>    
    ...
    <td bgcolor="#FF99FF" align="right"><?php echo $this->msistem->format_angka($J1) ?></td>
  ...
  <tr>    
    ...
    <td bgcolor="#99CCFF" align="right"><?php echo $this->msistem->format_angka($T1) ?></td>
