...
class walet_pdf extends MY_Controller {
	...
	public function index() {
		...
		$arr = "cetak";
		//setting pdf
		$this->load->library('header/walet');
		$pdf = new walet('P', 'pt', 'A4', true, 'UTF-8', false); 
...
<tr>
	<td colspan="3" height="10">&nbsp;</td>
							...
							<tr height="10" style="font-family: Arial,Helvetica Neue,Helvetica,sans-serif; font-weight:bold; font-size:9px">
	...
	<td colspan="3" height="10">&nbsp;</td>
		...
		$report .=
			'<table border=1>
				<tr>
					<td width="572" align="center">
						<strong>DATA PAJAK SARANG BURUNG WALET</strong>
					</td>
				</tr>
			</table>';
