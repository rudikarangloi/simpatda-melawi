...
class reklame_ins extends MY_Controller {
	...
	public function index() {
		...
		$this->load->view('data/reklame_ins',$data);
	}
...
WHERE sptpd_reklame.sifat_reklame='insidentil' ORDER BY no_sptpd DESC LIMIT 50"
                        ,"id"
,"no_sptpd,npwpd,nama_perusahaan,alamat_perusahaan,tema,tgl_diterima,cara_hitung,masa_pajak1,masa_pajak2,tahun_pajak,bulan1,bulan2,author,tgl_permohonan,tgl_diperiksa,jml_dipasang,jml_dibayar,id_reklame");}
