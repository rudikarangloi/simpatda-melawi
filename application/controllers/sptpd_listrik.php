...
class sptpd_listrik extends MY_Controller {
	...
	public function index() {
		...
		$tarif = $this->db->query("select tarif_pajak from master_rekening where kd_rek = '4.1.1.05.01'")->row();
...
sptpd_listrik.id AS id,
sptpd_listrik.npwpd AS npwpd,
sptpd_listrik.no_sptpd AS no_sptpd,
sptpd_listrik.cara_hitung AS cara_hitung,
sptpd_listrik.gol_tarif AS golongan,
sptpd_listrik.masa_pajak1 AS masa_pajak1,
sptpd_listrik.masa_pajak2 AS masa_pajak2,
sptpd_listrik.tgl_diterima AS tgl_diterima,
sptpd_listrik.omset AS omset,
sptpd_listrik.jml_bayar AS jml_bayar,
sptpd_listrik.petugas_input AS petugas_input,
...
FROM
sptpd_listrik
INNER JOIN identitas_perusahaan ON sptpd_listrik.npwpd = identitas_perusahaan.npwpd_perusahaan
INNER JOIN sptpd_child ON sptpd_listrik.no_sptpd = sptpd_child.no_sptpd","id","id,npwpd, no_sptpd, nama_perusahaan, alamat_perusahaan, cara_hitung, golongan, masa_pajak1, masa_pajak2, tgl_diterima,jml_bayar, petugas_input,omset,tarif");	
	}
	...
	public function simpan_sptpd() {
		...
		$data = array (
			...
			*/'cara_hitung' => $this->input->post('txtcarahitung'),
			'gol_tarif' => $this->input->post('txtgolhotel'),
			'masa_pajak11' 	=> $masapajak1,
			'masa_pajak21' 	=> $masapajak2,
			'masa_pajak12' 	=> $masapajak1,
			'masa_pajak22' 	=> $masapajak2,
		...
		if($this->input->post('id')!=0){
			...
			$this->db->update('sptpd_listrk', $dataUpd, array('id' => $this->input->post('id')));
...
sptpd_listrik.id AS id,
sptpd_listrik.npwpd AS npwpd,
view_perusahaan.npwpd_lama AS npwpd_lama,
sptpd_listrik.no_sptpd AS no_sptpd,
sptpd_listrik.cara_hitung AS cara_hitung,
sptpd_listrik.gol_tarif AS golongan,
DATE_FORMAT(sptpd_listrik.masa_pajak1,'%d/%m/%Y') AS masa_pajak1,
DATE_FORMAT(sptpd_listrik.masa_pajak2,'%d/%m/%Y') AS masa_pajak2,
DATE_FORMAT(sptpd_listrik.tgl_diterima,'%d/%m/%Y') AS tgl_terima,
sptpd_listrik.omset AS omset,
sptpd_listrik.jml_bayar AS jml_bayar,
sptpd_listrik.petugas_input AS petugas_input,
...
FROM
sptpd_listrik
INNER JOIN view_perusahaan ON sptpd_listrik.npwpd = view_perusahaan.npwpd_perusahaan INNER JOIN sptpd_child ON sptpd_listrik.no_sptpd = sptpd_child.no_sptpd WHERE sptpd_listrik.no_sptpd = '".$_GET['sptpd']."'")->row();
			...
			'<table border=1>
				<tr style="font-family: Arial,Helvetica Neue,Helvetica,sans-serif; font-weight:bold; font-size:10px">
					...
					<td width="210" align="center">
						...
						<b>PAJAK PENERANGAN JALAN</b><br /><br/>
...
<tr>
	<td colspan="3" height="10">&nbsp;</td>
							...
							<tr height="10" style="font-family: Arial,Helvetica Neue,Helvetica,sans-serif; font-weight:bold; font-size:10px">
								...
								<td width="10" align="center">:</td>
								<td width="340">'.$sql->golongan.'</td>
							</tr>
							<tr height="10" style="font-family: Arial,Helvetica Neue,Helvetica,sans-serif; font-weight:bold; font-size:10px">
								<td width="120">&nbsp;&nbsp;2. Nama Rekening</td>
								<td width="10" align="center">:</td>
								<td width="340">'.$sq->nm_rek.'</td>
							</tr>
<tr>
	<td colspan="3" height="10">&nbsp;</td>
</tr>
