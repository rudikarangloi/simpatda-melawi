...
class report_pajak extends MY_Controller {
    ...
    function laporan_bulanan(){
        $data['tahun'] = $this->msistem->tahun();
		$this->load->view('report_pajak/kartu_data_bulanan', $data);
    }
//realisasi excel 
	/* public function excel_real(){
		$data['type'] = 'excel';
		$data['data'] = $_GET['full'];
		$this->load->view('report_pajak/excel_real',$data);
	} */
	...
	function cetak_realisasi(){
		...
		$sql = $this->db->query("SELECT DISTINCT(identitas_perusahaan.npwpd_perusahaan) AS npwpd_perusahaan, DATE_FORMAT(identitas_perusahaan.tgl_daftar,'%d/%m/%Y') AS tanggal, identitas_perusahaan.nama_perusahaan, identitas_perusahaan.alamat_perusahaan FROM identitas_perusahaan LEFT JOIN sspd ON identitas_perusahaan.npwpd_perusahaan = sspd.npwpd WHERE sspd.tahun_transaksi = '".$tahun."' $qr order by identitas_perusahaan.nama_perusahaan ");
...
(SELECT SUM(pembayaran.setoran_wp) FROM sspd INNER JOIN pembayaran ON pembayaran.no_sspd = sspd.no_sspd WHERE sspd.npwpd = '".$npwpd."' AND sspd.tahun_transaksi < '".$tahun."' $qr) AS piutang,
(SELECT SUM(pembayaran.setoran_wp) FROM sspd INNER JOIN pembayaran ON pembayaran.no_sspd = sspd.no_sspd WHERE sspd.npwpd = '".$npwpd."' AND MONTH(sspd.tanggal) = '01' AND sspd.tahun_transaksi = '".$tahun."' $qr) AS s_1,
(SELECT SUM(pembayaran.setoran_wp) FROM sspd INNER JOIN pembayaran ON pembayaran.no_sspd = sspd.no_sspd WHERE sspd.npwpd = '".$npwpd."' AND MONTH(sspd.tanggal) = '02' AND sspd.tahun_transaksi = '".$tahun."' $qr) AS s_2,
(SELECT SUM(pembayaran.setoran_wp) FROM sspd INNER JOIN pembayaran ON pembayaran.no_sspd = sspd.no_sspd WHERE sspd.npwpd = '".$npwpd."' AND MONTH(sspd.tanggal) = '03' AND sspd.tahun_transaksi = '".$tahun."' $qr) AS s_3,
(SELECT SUM(pembayaran.setoran_wp) FROM sspd INNER JOIN pembayaran ON pembayaran.no_sspd = sspd.no_sspd WHERE sspd.npwpd = '".$npwpd."' AND MONTH(sspd.tanggal) = '04' AND sspd.tahun_transaksi = '".$tahun."' $qr) AS s_4,
(SELECT SUM(pembayaran.setoran_wp) FROM sspd INNER JOIN pembayaran ON pembayaran.no_sspd = sspd.no_sspd WHERE sspd.npwpd = '".$npwpd."' AND MONTH(sspd.tanggal) = '05' AND sspd.tahun_transaksi = '".$tahun."' $qr) AS s_5,
(SELECT SUM(pembayaran.setoran_wp) FROM sspd INNER JOIN pembayaran ON pembayaran.no_sspd = sspd.no_sspd WHERE sspd.npwpd = '".$npwpd."' AND MONTH(sspd.tanggal) = '06' AND sspd.tahun_transaksi = '".$tahun."' $qr) AS s_6,
(SELECT SUM(pembayaran.setoran_wp) FROM sspd INNER JOIN pembayaran ON pembayaran.no_sspd = sspd.no_sspd WHERE sspd.npwpd = '".$npwpd."' AND MONTH(sspd.tanggal) = '07' AND sspd.tahun_transaksi = '".$tahun."' $qr) AS s_7,
(SELECT SUM(pembayaran.setoran_wp) FROM sspd INNER JOIN pembayaran ON pembayaran.no_sspd = sspd.no_sspd WHERE sspd.npwpd = '".$npwpd."' AND MONTH(sspd.tanggal) = '08' AND sspd.tahun_transaksi = '".$tahun."' $qr) AS s_8,
(SELECT SUM(pembayaran.setoran_wp) FROM sspd INNER JOIN pembayaran ON pembayaran.no_sspd = sspd.no_sspd WHERE sspd.npwpd = '".$npwpd."' AND MONTH(sspd.tanggal) = '09' AND sspd.tahun_transaksi = '".$tahun."' $qr) AS s_9,
(SELECT SUM(pembayaran.setoran_wp) FROM sspd INNER JOIN pembayaran ON pembayaran.no_sspd = sspd.no_sspd WHERE sspd.npwpd = '".$npwpd."' AND MONTH(sspd.tanggal) = '10' AND sspd.tahun_transaksi = '".$tahun."' $qr) AS s_10,
(SELECT SUM(pembayaran.setoran_wp) FROM sspd INNER JOIN pembayaran ON pembayaran.no_sspd = sspd.no_sspd WHERE sspd.npwpd = '".$npwpd."' AND MONTH(sspd.tanggal) = '11' AND sspd.tahun_transaksi = '".$tahun."' $qr) AS s_11,
(SELECT SUM(pembayaran.setoran_wp) FROM sspd INNER JOIN pembayaran ON pembayaran.no_sspd = sspd.no_sspd WHERE sspd.npwpd = '".$npwpd."' AND MONTH(sspd.tanggal) = '12' AND sspd.tahun_transaksi = '".$tahun."' $qr) AS s_12
FROM sspd INNER JOIN pembayaran ON pembayaran.no_sspd = sspd.no_sspd")->row();*/
$detail = $this->db->query("SELECT 
(SELECT SUM(sspd.setoran) FROM sspd WHERE sspd.npwpd = '".$npwpd."' AND sspd.tahun_transaksi < '".$tahun."' $qr) AS piutang,
(SELECT SUM(sspd.setoran) FROM sspd WHERE sspd.npwpd = '".$npwpd."' AND MONTH(sspd.tanggal) = '01' AND sspd.tahun_transaksi = '".$tahun."' $qr) AS s_1,
(SELECT SUM(sspd.setoran) FROM sspd WHERE sspd.npwpd = '".$npwpd."' AND MONTH(sspd.tanggal) = '02' AND sspd.tahun_transaksi = '".$tahun."' $qr) AS s_2,
(SELECT SUM(sspd.setoran) FROM sspd WHERE sspd.npwpd = '".$npwpd."' AND MONTH(sspd.tanggal) = '03' AND sspd.tahun_transaksi = '".$tahun."' $qr) AS s_3,
(SELECT SUM(sspd.setoran) FROM sspd WHERE sspd.npwpd = '".$npwpd."' AND MONTH(sspd.tanggal) = '04' AND sspd.tahun_transaksi = '".$tahun."' $qr) AS s_4,
(SELECT SUM(sspd.setoran) FROM sspd WHERE sspd.npwpd = '".$npwpd."' AND MONTH(sspd.tanggal) = '05' AND sspd.tahun_transaksi = '".$tahun."' $qr) AS s_5,
(SELECT SUM(sspd.setoran) FROM sspd WHERE sspd.npwpd = '".$npwpd."' AND MONTH(sspd.tanggal) = '06' AND sspd.tahun_transaksi = '".$tahun."' $qr) AS s_6,
(SELECT SUM(sspd.setoran) FROM sspd WHERE sspd.npwpd = '".$npwpd."' AND MONTH(sspd.tanggal) = '07' AND sspd.tahun_transaksi = '".$tahun."' $qr) AS s_7,
(SELECT SUM(sspd.setoran) FROM sspd WHERE sspd.npwpd = '".$npwpd."' AND MONTH(sspd.tanggal) = '08' AND sspd.tahun_transaksi = '".$tahun."' $qr) AS s_8,
(SELECT SUM(sspd.setoran) FROM sspd WHERE sspd.npwpd = '".$npwpd."' AND MONTH(sspd.tanggal) = '09' AND sspd.tahun_transaksi = '".$tahun."' $qr) AS s_9,
(SELECT SUM(sspd.setoran) FROM sspd WHERE sspd.npwpd = '".$npwpd."' AND MONTH(sspd.tanggal) = '10' AND sspd.tahun_transaksi = '".$tahun."' $qr) AS s_10,
(SELECT SUM(sspd.setoran) FROM sspd WHERE sspd.npwpd = '".$npwpd."' AND MONTH(sspd.tanggal) = '11' AND sspd.tahun_transaksi = '".$tahun."' $qr) AS s_11,
(SELECT SUM(sspd.setoran) FROM sspd WHERE sspd.npwpd = '".$npwpd."' AND MONTH(sspd.tanggal) = '12' AND sspd.tahun_transaksi = '".$tahun."' $qr) AS s_12
FROM sspd")->row();
		...
		$s2 = $this->db->query("SELECT nama_ttd,nip_ttd,jabatan_ttd FROM master_tanda_tangan where id = '5'")->row();
		if($s2==NULL){
			$nama2 = '';
			$nip2 = '';
		} else {
...
FROM sspd")->row();
	...
	function data_realisasi($pajak="",$tahun=""){
		...
		//$sql = $this->db->query("SELECT DISTINCT(view_perusahaan.npwpd_perusahaan) AS npwpd_perusahaan, view_perusahaan.nama_perusahaan, view_perusahaan.alamat_perusahaan FROM view_perusahaan LEFT JOIN sspd ON view_perusahaan.npwpd_perusahaan = sspd.npwpd WHERE sspd.tahun_transaksi = '".$tahun."' $qr order by view_perusahaan.nama_perusahaan");
		$sql = $this->db->query("SELECT DISTINCT(identitas_perusahaan.npwpd_perusahaan) AS npwpd_perusahaan, DATE_FORMAT(identitas_perusahaan.tgl_daftar,'%d/%m/%Y') AS tanggal,identitas_perusahaan.nama_perusahaan, identitas_perusahaan.alamat_perusahaan FROM identitas_perusahaan 
LEFT JOIN sspd ON identitas_perusahaan.npwpd_perusahaan = sspd.npwpd WHERE sspd.tahun_transaksi = '".$tahun."' $qr order by identitas_perusahaan.nama_perusahaan");
...
FROM sptpd")->row();
    ...
    function data_realisasi_denda($pajak="",$tahun=""){
		...
		$sql = $this->db->query("SELECT DISTINCT(view_perusahaan.npwpd_perusahaan) AS npwpd_perusahaan, view_perusahaan.nama_perusahaan, view_perusahaan.alamat_perusahaan FROM view_perusahaan 
LEFT JOIN sspd ON view_perusahaan.npwpd_perusahaan = sspd.npwpd
LEFT JOIN pembayaran ON pembayaran.no_sspd = sspd.no_sspd WHERE sspd.tahun_transaksi = '".$tahun."' $qr order by view_perusahaan.nama_perusahaan");
...
FROM sspd")->row();
	...
	function data_rekon($bayar="",$periode="",$akhir=""){
		...
		for($tgl=1;$tgl<=$akhir;$tgl++){
			...
			$time = $periode.'-'.$tgl;
			$sql = $this->db->query("SELECT DATE_FORMAT(sspd.tanggal,'%d/%m/%Y') AS tanggal, 
sspd.pembayaran, 
SUM(pembayaran.setoran_wp) AS setoran FROM sspd
INNER JOIN pembayaran ON pembayaran.no_sspd = sspd.no_sspd where sspd.tanggal = '".$time."' and sspd.pembayaran = '".$bayar."' order by sspd.tanggal asc")->row();
...
INNER JOIN pembayaran ON pembayaran.no_sspd = sspd.no_sspd where sspd.tanggal = '".$time."' and sspd.pembayaran = '".$bayar."' order by sspd.tanggal asc")->row();
	...
	function data_sself($awal="",$akhir="",$pajak=""){
		...
		$sql = $this->db->query("SELECT DATE_FORMAT(sptpd.tanggal,'%d/%m/%Y') AS tgl, sptpd.no_sptpd, 
DATE_FORMAT(sspd.tanggal,'%d/%m/%Y') AS tanggal, identitas_perusahaan.nama_perusahaan, 
identitas_perusahaan.alamat_perusahaan, identitas_perusahaan.npwpd_perusahaan, sspd.no_sspd, sspd.ketetapan, sspd.setoran, sspd.denda 
,sptpd.status,sspd.status FROM sspd 
LEFT JOIN identitas_perusahaan ON identitas_perusahaan.npwpd_perusahaan = sspd.npwpd
LEFT JOIN view_no ON sspd.no_sspd = view_no.no_sspd
LEFT JOIN sptpd ON sptpd.no_sptpd = view_no.sptpd
WHERE sspd.tanggal >= '".$awal."' AND sspd.tanggal <= '".$akhir."' AND sptpd.status = '1' $qr");
...
WHERE sspd.tanggal >= '".$awal."' AND sspd.tanggal <= '".$akhir."' AND sptpd.status = '1' $qr");
	...
	function data_tetap($awal="",$akhir="",$pajak=""){
		...
		$sql = $this->db->query("SELECT DATE_FORMAT(skpd.tgl,'%d/%m/%Y') AS tgl, skpd.no_skpd, DATE_FORMAT(sspd.tanggal,'%d/%m/%Y') AS tanggal, 
		sspd.no_sspd, identitas_perusahaan.nama_perusahaan, identitas_perusahaan.alamat_perusahaan, identitas_perusahaan.npwpd_perusahaan, 
		sspd.ketetapan, sspd.setoran, sspd.denda  FROM sspd
LEFT JOIN identitas_perusahaan ON identitas_perusahaan.npwpd_perusahaan = sspd.npwpd
LEFT JOIN view_no ON sspd.no_sspd = view_no.no_sspd
LEFT JOIN skpd ON skpd.no_skpd = view_no.no_skpd 
WHERE skpd.tgl >= '".$awal."' and skpd.tgl <= '".$akhir."' AND skpd.status='1' $qr");
		...
		$report .=
			'<table border=1>
				<tr>
					...
					<td rowspan="2" width="85" height="15" align="center"><strong>KETETAPAN</strong></td>
					<td rowspan="2" width="65" height="15" align="center"><strong>DENDA</strong></td>
					<td rowspan="2" width="85" height="15" align="center"><strong>PENYETORAN</strong></td>
				</tr>
				<tr>
	...
	public function data_kartu($npwpd="",$awal="",$akhir=""){
		...
		$sql = $this->db->query("SELECT view_perusahaan.npwpd_perusahaan, sspd.no_sspd, DATE_FORMAT(sspd.tanggal,'%d/%m/%Y') AS tanggal, sspd.masa_pajak1, sspd.masa_pajak2, sspd.tahun_pajak, sspd.ketetapan, sspd.denda, sspd.setoran, sspd.keterangan FROM view_perusahaan 
INNER JOIN sspd ON view_perusahaan.npwpd_perusahaan = sspd.npwpd
where view_perusahaan.npwpd_perusahaan = '".$npwpd."' and sspd.tahun_pajak >= '".$awal."' and sspd.tahun_pajak <= '".$akhir."' order by sspd.tahun_pajak asc");				
		
		$i=1;
		foreach($sql->result() as $rs) {
			
		if(substr($rs->npwpd_perusahaan,0,1)=="4"){		
			$dquery = $this->db->query('SELECT b.masa_pajak1 as ms1,b.masa_pajak2 as ms2 FROM view_no a
			LEFT JOIN sptpd_reklame b ON b.no_sptpd = a.sptpd
			WHERE a.no_sspd="'.$rs->no_sspd.'"')->row();
			$s1 = explode("-",$dquery->ms1);
			$thn1 = $s1[0];
			$bln1 = $s1[1];
			$tgl1 = $s1[2];
			
			$s2 = explode("-",$dquery->ms2);
			$thn2 = $s2[0];
			$bln2 = $s2[1];
			$tgl2 = $s2[2];
			
			$bulan1 = $tgl1."/".$bln1."/".$thn1;
			$bulan2 = $tgl2."/".$bln2."/".$thn2;
		}else{
...
sptpd.masa_pajak2, sptpd.tahun, sptpd.jumlah AS ketetapan, sspd.denda, pembayaran.setoran_wp, IF(sptpd.status=1,'Sudah bayar','Belum Bayar') AS keterangan FROM view_perusahaan
INNER JOIN sptpd ON view_perusahaan.npwpd_perusahaan = sptpd.npwpd
LEFT JOIN sspd ON sptpd.no_sptpd=sspd.nomor
LEFT JOIN pembayaran ON pembayaran.no_sspd=sspd.no_sspd
WHERE view_perusahaan.npwpd_perusahaan = '".$npwpd."'
...
");   
    ...
    public function data_kartu_skpd($awal="",$akhir=""){
...
$sql = $this->db->query("SELECT skpd.no_skpd,skpd.tgl,sspd.no_sspd,sspd.tanggal,pembayaran.no_tbp,
 (CASE sspd.kode_pajak 
      WHEN 'HTL' THEN 'Pajak Hotel'
      WHEN 'RES' THEN 'Pajak Restoran'
      WHEN 'HIB' THEN 'Pajak Hiburan'
      WHEN 'REK' THEN 'Pajak Reklame'
      WHEN 'LIS' THEN 'Pajak Penerangan Jalan'
      WHEN 'PKR' THEN 'Pajak Parkir'
      WHEN 'AIR' THEN 'Pajak Air Bawah Tanah'
      WHEN 'WLT' THEN 'Pajak Sarang Burung Walet'
      WHEN 'GAL' THEN 'Pajak Mineral Bukan Logam dan Batuan' 
      ELSE ''
   END) AS uraian_pajak, sspd.setoran,sspd.keterangan FROM sspd 
   INNER JOIN skpd ON sspd.nomor=skpd.no_skpd
   INNER JOIN pembayaran ON sspd.no_sspd=pembayaran.no_sspd WHERE sspd.tanggal >='$awal' AND sspd.tanggal <='$akhir'  ORDER BY sspd.no_sspd,sspd.tanggal");
		...
		foreach($sql->result() as $rs) {
			...
			echo ("<row id='".$i."'>");
				...
				echo("<cell><![CDATA[".$rs->no_sspd."]]></cell>");
				echo("<cell><![CDATA[".$rs->tanggal."]]></cell>");
				echo("<cell><![CDATA[".$rs->no_tbp."]]></cell>");
				echo("<cell><![CDATA[".$rs->uraian_pajak."]]></cell>");
				echo("<cell><![CDATA[".$rs->setoran."]]></cell>");
				echo("<cell><![CDATA[".$rs->keterangan."]]></cell>");
			echo ("</row>");
			$i++;
...
AND sptpd.tahun >= '".$awal."' AND sptpd.tahun <= '".$akhir."' ORDER BY sptpd.tahun,sptpd.masa_pajak1 ASC");   
	...
	public function cetak_kartu(){
		...
		$report .=
			'<table border=1>
				<tr>
					...
					<td width="90" height="15" align="center"><strong>NO. SSPD</strong></td>
					<td width="55" height="15" align="center"><strong>TGL</strong></td>
					<td width="120" height="15" align="center"><strong>MASA PAJAK</strong></td>
					<td width="45" height="15" align="center"><strong>TAHUN</strong></td>
					<td width="105" height="15" align="center"><strong>JUMLAH PAJAK</strong></td>
					<td width="105" height="15" align="center"><strong>DENDA</strong></td>
					<td width="105" height="15" align="center"><strong>REALISASI</strong></td>
		...
		$sql = $this->db->query("SELECT view_perusahaan.npwpd_perusahaan, sspd.no_sspd, DATE_FORMAT(sspd.tanggal,'%d/%m/%Y') as tanggal, sspd.masa_pajak1, sspd.masa_pajak2, sspd.tahun_pajak, 
		sspd.ketetapan, sspd.denda, sspd.setoran, sspd.keterangan FROM view_perusahaan 
		INNER JOIN sspd ON view_perusahaan.npwpd_perusahaan = sspd.npwpd where view_perusahaan.npwpd_perusahaan = '".$npwpd."' and 
		sspd.tahun_pajak >= '".$awal."' and sspd.tahun_pajak <= '".$akhir."' order by sspd.tahun_pajak asc");
		$no = 1;
		$tetap = 0;
		$tdenda = 0;
		$setor = 0;
		...
		$report .=
				'<tr>
					...
					<td width="90" height="15" align="center">'.$rs->no_sspd.'</td>
					<td width="55" height="15" align="center">'.$rs->tanggal.'</td>
					<td width="120" height="15" align="center">'.$awal.' - '.$akhir.'</td>
		...
		$report .=
				'<tr>
					<td width="330" height="15" align="center"><strong>Jumlah</strong></td>
					<td width="105" height="15" align="right"><strong>Rp. '.number_format($tetap,2,",",".").'&nbsp;</strong></td>
					<td width="105" height="15" align="right"><strong>Rp. '.number_format($tdenda,2,",",".").'&nbsp;</strong></td>
					<td width="105" height="15" align="right"><strong>Rp. '.number_format($setor,2,",",".").'&nbsp;</strong></td>
					<td width="95" height="15" align="center">&nbsp;</td>
...
(SELECT SUM(pembayaran.setoran_wp) FROM sspd INNER JOIN pembayaran ON pembayaran.no_sspd = sspd.no_sspd WHERE sspd.tanggal = '".$time."' AND sspd.kode_pajak = 'HTL') AS s_1,
(SELECT SUM(pembayaran.setoran_wp) FROM sspd INNER JOIN pembayaran ON pembayaran.no_sspd = sspd.no_sspd WHERE sspd.tanggal = '".$time."' AND sspd.kode_pajak = 'RES') AS s_2,
(SELECT SUM(pembayaran.setoran_wp) FROM sspd INNER JOIN pembayaran ON pembayaran.no_sspd = sspd.no_sspd WHERE sspd.tanggal = '".$time."' AND sspd.kode_pajak = 'REK') AS s_3,
(SELECT SUM(pembayaran.setoran_wp) FROM sspd INNER JOIN pembayaran ON pembayaran.no_sspd = sspd.no_sspd WHERE sspd.tanggal = '".$time."' AND sspd.kode_pajak = 'HIB') AS s_4,
(SELECT SUM(pembayaran.setoran_wp) FROM sspd INNER JOIN pembayaran ON pembayaran.no_sspd = sspd.no_sspd WHERE sspd.tanggal = '".$time."' AND sspd.kode_pajak = 'LIS') AS s_5,
(SELECT SUM(pembayaran.setoran_wp) FROM sspd INNER JOIN pembayaran ON pembayaran.no_sspd = sspd.no_sspd WHERE sspd.tanggal = '".$time."' AND sspd.kode_pajak = 'GAL') AS s_6,
(SELECT SUM(pembayaran.setoran_wp) FROM sspd INNER JOIN pembayaran ON pembayaran.no_sspd = sspd.no_sspd WHERE sspd.tanggal = '".$time."' AND sspd.kode_pajak = 'PKR') AS s_7,
(SELECT SUM(pembayaran.setoran_wp) FROM sspd INNER JOIN pembayaran ON pembayaran.no_sspd = sspd.no_sspd WHERE sspd.tanggal = '".$time."' AND sspd.kode_pajak = 'WLT') AS s_8,
(SELECT SUM(pembayaran.setoran_wp) FROM sspd INNER JOIN pembayaran ON pembayaran.no_sspd = sspd.no_sspd WHERE sspd.tanggal = '".$time."' AND sspd.kode_pajak = 'AIR') AS s_9
FROM sspd INNER JOIN pembayaran ON pembayaran.no_sspd = sspd.no_sspd")->row(); */

$sql = $this->db->query("SELECT
(SELECT SUM(sspd.setoran) FROM sspd  WHERE sspd.tanggal = '".$time."' AND sspd.kode_pajak = 'HTL') AS s_1,
(SELECT SUM(sspd.setoran) FROM sspd  WHERE sspd.tanggal = '".$time."' AND sspd.kode_pajak = 'RES') AS s_2,
(SELECT SUM(sspd.setoran) FROM sspd  WHERE sspd.tanggal = '".$time."' AND sspd.kode_pajak = 'REK') AS s_3,
(SELECT SUM(sspd.setoran) FROM sspd  WHERE sspd.tanggal = '".$time."' AND sspd.kode_pajak = 'HIB') AS s_4,
(SELECT SUM(sspd.setoran) FROM sspd  WHERE sspd.tanggal = '".$time."' AND sspd.kode_pajak = 'LIS') AS s_5,
(SELECT SUM(sspd.setoran) FROM sspd  WHERE sspd.tanggal = '".$time."' AND sspd.kode_pajak = 'GAL') AS s_6,
(SELECT SUM(sspd.setoran) FROM sspd  WHERE sspd.tanggal = '".$time."' AND sspd.kode_pajak = 'PKR') AS s_7,
(SELECT SUM(sspd.setoran) FROM sspd  WHERE sspd.tanggal = '".$time."' AND sspd.kode_pajak = 'WLT') AS s_8,
(SELECT SUM(sspd.setoran) FROM sspd  WHERE sspd.tanggal = '".$time."' AND sspd.kode_pajak = 'AIR') AS s_9
FROM sspd")->row();
...
FROM sspd INNER JOIN pembayaran ON pembayaran.no_sspd = sspd.no_sspd")->row(); */
			...
			$sql = $this->db->query("SELECT
(SELECT SUM(sspd.total_setoran) FROM sspd  WHERE sspd.tanggal = '".$time."' AND sspd.kode_pajak = 'HTL') AS s_1,
(SELECT SUM(sspd.total_setoran) FROM sspd  WHERE sspd.tanggal = '".$time."' AND sspd.kode_pajak = 'RES') AS s_2,
(SELECT SUM(sspd.total_setoran) FROM sspd  WHERE sspd.tanggal = '".$time."' AND sspd.kode_pajak = 'REK') AS s_3,
(SELECT SUM(sspd.total_setoran) FROM sspd  WHERE sspd.tanggal = '".$time."' AND sspd.kode_pajak = 'HIB') AS s_4,
(SELECT SUM(sspd.setoran) FROM sspd  WHERE sspd.tanggal = '".$time."' AND sspd.kode_pajak = 'LIS') AS s_5,
(SELECT SUM(sspd.total_setoran) FROM sspd  WHERE sspd.tanggal = '".$time."' AND sspd.kode_pajak = 'GAL') AS s_6,
(SELECT SUM(sspd.total_setoran) FROM sspd  WHERE sspd.tanggal = '".$time."' AND sspd.kode_pajak = 'PKR') AS s_7,
(SELECT SUM(sspd.total_setoran) FROM sspd  WHERE sspd.tanggal = '".$time."' AND sspd.kode_pajak = 'WLT') AS s_8,
(SELECT SUM(sspd.total_setoran) FROM sspd  WHERE sspd.tanggal = '".$time."' AND sspd.kode_pajak = 'AIR') AS s_9
FROM sspd")->row();
