...
<script language="javascript">
    ...
    <div style="height:100%; overflow:auto;">
        ...
        <div id="content" style="overflow: auto;">
            <h2 style="margin:30px 5px 25px 30px;">Input Realisasi PBB dan BPHTB</h2>
...
var mdp = "";
function runmdp(){
mdp = new dataProcessor("<?php echo base_url()."index.php/pajaklain2/reklame_detail"; ?>");
...
//	}
	...
	function cetak_per() {
		...
		var b = document.frmData.sptpd_2.value;
		var c = a+'/'+b;
		window.open('<?php echo site_url(); ?>/pajaklain2/cetak2?sptpd='+c, '', 'height=700,width=1000,scrollbars=yes');
	}
...
//		}
	...
	function buat_id(){
		var postCek =
			"cek_baru=" + "baru";
		statusLoading();
		dhtmlxAjax.post(base_url+'index.php/pajaklain2/buatid', postCek, resPOSTid);
	}
	...
	function cek(){
		...
		statusLoading();
		dhtmlxAjax.post(base_url+'index.php/pajaklain2/ricek', postCek, resPOST);
	}
	...
	function simpan2(){			
		...
		tngx = skpd.replace(/&gt;/g,">"); */
            ...
            dhtmlxAjax.post("pajaklain2/simpan", encodeURI(poststr), outputResponse);
        }
	...
	function loadData(){
	gridData.clearAll();	
	gridData.loadXML(base_url+"index.php/pajaklain2/load_data",function() { 
        });
	...
	function selectData(id){
      ...
      //  document.frmData.npwpd.value = gridData.cells(id,1).getValue();
		...
		mygrid.clearAll();
		mygrid.loadXML("<?php echo base_url()."index.php/pajaklain2/load_detail_edit/"?>"+no);	
			...
			if(name=='dispenda'){
				...
				if(cnf) {
					var postStr =
						...
						"&sptpd_2=" + document.frmData.sptpd_2.value;
					statusLoading();
					dhtmlxAjax.post(base_url+'index.php/pajaklain2/hapus', postStr, function(loader) {
						result = loader.xmlDoc.responseText;
						alert(result);
						gridData.clearAll();
						loadData();
	...
	function cariDataWP() {	
		...
		statusLoading();
		gridWP.clearAll();	
		gridWP.loadXML(base_url+"index.php/pajaklain2/cariDataWP/"+document.frmSrc.keyword.value+"/"+document.frmSrc.parameter.value,function() {  								
		statusEnding();
...
function sumColumn(ind) {
	...
	function get_kawasan(){
		...
		statusLoading();
		dhtmlxAjax.post(base_url+'index.php/pajaklain2/kawasan', postJln, respJns);			
	}
	...
	function get_ketetapan(){
		...
		statusLoading();
		dhtmlxAjax.post(base_url+'index.php/pajaklain2/pokok', postKet, respKet);			
	}
	...
	function respKet(loader) {
	 ...
	 function crek_pajak() {
		...
		//statusLoading();
		//alert(postStr);
		dhtmlxAjax.post(base_url+'index.php/pajaklain2/crek_pajak', postStr, wenePOST_rek);
	}
	...
	function crek_skpd() {
		...
		dhtmlxAjax.post(base_url+'index.php/pajaklain2/crek_skpd', postStr, wenePOST_skpd);
	}
