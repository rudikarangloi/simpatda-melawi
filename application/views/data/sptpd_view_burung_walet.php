...
<script type="text/javascript" language="javascript">
	...
	var iViewClass	= iBaseUrl + 'index.php' + '/sptpd_burung_walet/data_sptpd';
</script>
<style>
		body {
			background:#FFF;
...
<h2 style="margin:30px 5px 25px 30px;">SPTPD Burung Walet</h2>
...
<script language="javascript">
	...
	grid.loadXML("<?php echo site_url(); ?>/sptpd_burung_walet/data_sptpd");
	grid.init();
