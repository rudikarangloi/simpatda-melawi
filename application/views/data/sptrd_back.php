...
<h2 style="margin:30px 5px 25px 30px;">SPTRD</h2>
	
<div id="a_tabbar" style="width:1100px; height:730px; margin-left:30px;"></div>
...
//                                    if(isset($reklame)) { $opt="selected"; } else { $opt=""; }
                            ...
                            ?>
                    </select>&nbsp;&nbsp;Jumlah&nbsp;&nbsp;<input type="text" id="qty" name="qty" size="7" />&nbsp;&nbsp;Tarif&nbsp;&nbsp;<input type="text" id="harga" name="harga" size="10" />
                    <input type="button" value="Tambah Data" onclick="add()" name="tambah" id="tambah" disabled="disabled" style="padding-left:10px; padding-right:10px" />
...
var base_url = "<?php echo base_url(); ?>";
	...
	gride1.setHeader("Kode,Nama Rekening,Jumlah,Harga Tarif,Dasar Pengenaan,Tarif,Total Jumlah,sptrd");
	...
	grid.setHeader("id, no_sptrd, npwpd, nama_perusahaan, alamat, cara_hitung, tgl_diterima, keperluan, Omset, petugas_input, masa_pajak1, masa_pajak2, Jumlah bayar,tarif,kode_pasar",null,["text-align:center","text-align:center","text-align:center","text-align:center"]);
	...
	function selectedOpenData(id) {
        ...
        document.frmData.lokasi.value = format_number(grid.cells(id,14).getValue());
