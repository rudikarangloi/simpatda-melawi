...
<div align="center">
	...
	<h2>Laporan Realisasi Pajak Dan Retribusi Harian</h2>
	<form name="tetap" id="tetap">
    	<table>
        	<tr>
            	<td style="padding-left:15px;">Tanggal</td>
                <td><input type="text" name="awal" id="awal" size="15" />
...
function cetak(pilih) {
	...
	akhir = p[2]+'-'+p[1]+'-'+p[0];*/
 	...
 	var marginBawah = document.tetap.marginBawah.value;
	full = awal+'|' +marginBawah+'|'+pilih;
	window.open('<?php echo site_url(); ?>/report_pajak2/cetak_lap_pad2?full='+full, '', 'height=700,width=1000,scrollbars=yes');
}
