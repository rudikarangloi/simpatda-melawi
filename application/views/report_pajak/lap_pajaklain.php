...
<div align="center">
	...
	<h2>Laporan Realisasi Dana Perimbangan, Bagi Hasil Dan Penerimaan Lain-lain</h2>
...
function cetak(pilih) {
	...
	window.open('<?php echo site_url(); ?>/report_pajak2/cetak_lap_pajaklain?full='+full, '', 'height=700,width=1000,scrollbars=yes');
}
