...
<div align="center">
	...
	<h2>Laporan SKP Sudah Bayar (Official Assesment)</h2>
...
function tpdf(){
	...
	window.open('<?php echo site_url(); ?>/report_pajak/cetak_tetap?full='+full, '', 'height=700,width=1000,scrollbars=yes');
}
...
function txls(){
	...
	full = awal+'|'+akhir+'|'+document.tetap.jenis_pajak.value;
	window.open('<?php echo site_url(); ?>/report_pajak/excel_tetap?full='+full, '', 'height=700,width=1000,scrollbars=yes');
}
...
function tampil(){
	...
	mygrid.clearAll();
	mygrid.loadXML("<?php echo site_url(); ?>/report_pajak/data_tetap/"+awal+"/"+akhir+"/"+document.tetap.jenis_pajak.value,function() {
...
mygrid.attachHeader(["#rspan", "  TGL SK  ", "NO. SKP", "TGL SETOR", "NO. SSPD", "#rspan", "#rspan", "#rspan","#rspan", "#rspan","#rspan"]);
