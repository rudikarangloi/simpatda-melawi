...
function tampil(){
	...
	mygrid.clearAll();
	mygrid.loadXML("<?php echo site_url(); ?>/report_pajak2/data_bank/"+bayar+"/"+periode+"/"+pajak,function() {
...
mygrid.setHeader("No.,No. SPTPD, Tgl SPTPD, No. SSPD, Tgl SSPD, Nama Perusahaan, Alamat Perusahaan, NPWPD, Jenis Pajak, Gol. Jenis Pajak, Masa Pajak, Tahun Pajak, Pajak Tahun Berjalan, Piutang Pajak, Denda, Total Bayar",
