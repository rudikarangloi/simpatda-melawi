	...
	<form name="tetap" id="tetap">
    	<table>
        	...
        	<tr>
                ...
                <input type="button" name="texcel" id="texcel" onclick="excel_perusahaan();" value="Cetak to Excel" style="padding-left:20px; padding-right:20px" disabled/>&nbsp;
				<input type="button" value="Display All" o
...
function excel_perusahaan(){
	...
	window.open('<?php echo site_url(); ?>/report_pajak2/excel_perusahaan?full='+full, '', 'height=700,width=1000,scrollbars=yes');
}
...
function tampil(){	
	...
	mygrid.loadXML("<?php echo site_url(); ?>/report_pajak2/data_usaha/"+awal+"/"+akhir+"/"+pajak,function() {
		...
		document.tetap.texcel.disabled = false;
		statusEnding();
	});
}
