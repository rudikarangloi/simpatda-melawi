...
<div align="center">
	...
	<h2>Laporan Tunggakan/Piutang Pajak Berdasarkan SPTPD  </h2>
...
function pdf() {
	...
	window.open('<?php echo site_url(); ?>/report_pajak/cetak_laporan_tunggakan?full='+full, '', 'height=700,width=1000,scrollbars=yes');
}
...
function tampil(){
	...
	mygrid.clearAll();
	mygrid.loadXML("<?php echo site_url(); ?>/report_pajak/data_laporan_tunggakan/"+document.tetap.jenis_pajak.value+"/"+document.tetap.tahun.value,function() {
...
mygrid.setHeader("No. ,Nama Wajib Pajak, Alamat, Piutang,Januari,Februari,Maret,April,Mei,Juni,Juli,Agustus,September,Oktober,November,Desember",//27
...
mygrid.attachHeader(["#rspan", "#rspan", "#rspan", "#rspan", "Tunggakan/Piutang", "Tunggakan/Piutang", "Tunggakan/Piutang", "Tunggakan/Piutang", "Tunggakan/Piutang", "Tunggakan/Piutang", "Tunggakan/Piutang", "Tunggakan/Piutang", "Tunggakan/Piutang", "Tunggakan/Piutang", "Tunggakan/Piutang", "Tunggakan/Piutang"]);
mygrid.setInitWidths("40,200,300,100,120,120,120,120,120,120,120,120,120,120,120,120");
