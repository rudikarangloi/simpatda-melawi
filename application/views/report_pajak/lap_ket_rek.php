...
<div align="center">
	...
	<h2>Laporan Daftar Ketetapan Pajak Reklame</h2>
...
function pdf() {
	...
	window.open('<?php echo site_url(); ?>/report_pajak2/cetak_ket_rek?full='+full, '', 'height=700,width=1000,scrollbars=yes');
}
...
function txls(){
	...
	window.open('<?php echo site_url(); ?>/report_pajak2/excel_ket_rek?full='+full, '', 'height=700,width=1000,scrollbars=yes');
}
...
function tampil(){
	...
	mygrid.clearAll();
	mygrid.loadXML("<?php echo site_url(); ?>/report_pajak2/data_ket_rek/"+awal+"/"+akhir+"/"+pajak,function() {
		awal2 = s[2]+'-01-01';
		if(akhir2<awal2){
...
mygrid.setHeader("No. ,Nama, Alamat Perusahaan, NPWPD, No SKP, Merek, Tema, Tgl SKP, Tgl SSPD, Masa Pajak , Pokok, Denda, Jumlah,Status SKP",//13
...
mygrid.setInitWidths("40,200,200,150,100,150,200,100,100,125,110,110,110,110");
mygrid.setColAlign("center,left,left,center,left,center,center,center,center,center,right,right,right,center");
mygrid.setColTypes("ro,ro,ro,ro,ro,ro,ro,ron,ron,ron,ron,ron,ron,ron");
mygrid.setNumberFormat("0,000",10,",",".");
mygrid.setNumberFormat("0,000",11,",",".");
mygrid.setNumberFormat("0,000",12,",",".");
mygrid.setColSorting("str,str,str,str,str,str,str,str,str,str,int,int,int,str");
