...
function pdf() {
	...
	window.open('<?php echo site_url(); ?>/report_pajak2/ttd_ktgl?full='+full, '', 'height=700,width=1000,scrollbars=yes');
}
...
function tampil(){
	...
	statusLoading();	
	mygrid.clearAll();
	mygrid.loadXML("<?php echo site_url(); ?>/report_pajak2/data_ktgl/"+awal+"/"+akhir+"/"+pajak,function() {
		awal2 = s[2]+'-01-01';
		if(akhir2<awal2){
...
mygrid.setHeader("No. ,No.SSPD, Tanggal Bayar,Tanggal SKP , Uraian, Kode Rekening, Nama Rekening, Pokok, Denda, Penerimaan",//27
