...
body{
  ...
  <h2 style="margin:30px 5px 25px 30px;">SKRD2 <?php echo $nama_sptpd; ?></h2>
...
<div style="padding:0 75px 0 15px;">
  ...
  <script language="javascript">
	...
	//gridData.setHeader("Kode Rekening,Nama Rekening,DP,Tarif,Kenaikan,Denda,Bunga,Kompensasi,Jumlah,SKRD");
	gridData.setHeader("Kode Rekening,Nama Rekening,Tarif,Jumlah,SKRD");
    //gridData.setInitWidths("100,120,80,80,80,80,80,80,80,80");
    gridData.setInitWidths("100,400,80,80,80");
	//gridData.setColAlign("left,left,right,right,right,right,right,right,right,left");
	gridData.setColAlign("left,left,right,right,left");
    //gridData.setColTypes("ro,ro,ron,ron,ron,ron,ron,ron,ron,ro");
    gridData.setColTypes("ro,ro,ron,ron,ro");
	...
	grid.setHeader("No.SKPD,Tanggal,Nama Usaha,Alamat Usaha,Nama Pemilik,Alamat,NPWPD,Total,Bln Awal,Bln Akhir,Tahun,Tgl Tempo,NO.SPTRD,Nota Hitung,No Kohir");
