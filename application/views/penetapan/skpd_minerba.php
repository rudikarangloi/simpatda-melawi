  ...
  <script language="javascript">
	...
	function ubahKel(){
  	...
  	function cet(){
		...
		window.open('<?php echo site_url(); ?>/skpd/cetak_minerba?skpd='+gabung, '', 'height=700,width=1000,scrollbars=yes');
	}
	...
	gridWP.attachEvent("onRowDblClicked", function(id) {
		...
		if(ket_tbhn != "") document.frmSKPD.ket_skpd.value = ket_tbhn + ", " + ket_denda;
		else document.frmSKPD.ket_skpd.value = "";
	...
	gridData.setHeader("Kode Rekening,Nama Rekening,Omset,Tarif,Kenaikan,Denda,Bunga,Kompensasi,Jumlah,SKPD");
