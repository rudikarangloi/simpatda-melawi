...
body{
  ...
  <div id="a_tabbar" style="width:1000px; height:535px; margin-left:30px;"></div>
...
<div style="padding:0 75px 0 15px;">
  ...
  <script language="javascript">
	...
	gridWP.setHeader("No.Nota,SPTPD,NPWPD,Nama Perusahaan,Alamat Perusahaan,Pemilik,Alamat Pemilik,masa_pajak_1,masa_pajak_2,tahun,jml");
	...
	grid.setHeader("No.SKPD,Tanggal,Nama Usaha,Alamat Usaha,Nama Pemilik,Alamat,NPWPD,Total,Bln Awal,Bln Akhir,Tahun,Tgl Tempo,NO.SPTPD,Nota Hitung,No Kohir");
	grid.setInitWidths("100,100,100,100,100,100,100,100,100,100,100,100,100,100,100");
	grid.setColAlign("left,left,left,left,left,left,left,right,right,left,left,left,left,left,left");
	grid.setColTypes("ro,ro,ro,ro,ro,ro,ro,ron,ron,ro,ro,ro,ro,ro,ro");
