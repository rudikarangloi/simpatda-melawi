...
<table width="200" border="0">
	<tr>
    	<td colspan="4" align="center"><strong>Pajak Reklame</strong></td>
...
z1.attachEvent("onKeyPressed", function(keyCode){		
	...
	function preview() {	
		...
		window.open(base_url+"index.php/data_potensi/potensi/reklame/"+kec+"/"+kel,'width=500,height=400,scrollbars=1');
	}
	
	function toExcel(){
		var kec = z.getSelectedValue();
		var kel = z1.getSelectedValue();
		window.location = base_url+"index.php/data_potensi/toexcel/reklame/"+kec+"/"+kel,'Report','width=500,height=400';
	}
