...
<body bgcolor="#99CCFF">
<strong>DATA POTENSI SARANG BURUNG WALET</strong>
...
z1.attachEvent("onKeyPressed", function(keyCode){		
	...
	function preview() {	
		...
		window.open(base_url+"index.php/data_potensi/potensi/walet/"+kec+"/"+kel,'width=500,height=400,scrollbars=1');
	}
	
	function toExcel(){
		var kec = z.getSelectedValue();
		var kel = z1.getSelectedValue();
		window.location = base_url+"index.php/data_potensi/toexcel/walet/"+kec+"/"+kel,'Report','width=500,height=400';
	}
