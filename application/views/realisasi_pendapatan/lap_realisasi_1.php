...
<div align="center">
    ...
    <h2>Laporan Realisasi Penerimaan Rincian Pendapatan</h2>
    <form name="bln" id="bln">
        <table width="300" border="0">
            <tr>
                <td width="150" style="padding-left:15px;">Bulan Penerimaan</td>
                <td width="150">
            ...
            <tr>
                <td width="150" style="padding-left:15px;">Tahun Penerimaan</td>
                <td width="150">
...
function tampil(){
    ...
    statusLoading();
    mygrid.clearAll();
    mygrid.loadXML("<?php echo site_url(); ?>/realisasi_pendapatan/data_realisasi/"+periode,function() {
...
mygrid.loadXML("<?php echo site_url(); ?>/realisasi_pendapatan/data_realisasi");
mygrid.init();
</script>
