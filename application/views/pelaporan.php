...
<div id="gridContent" style="width:990px; height:300px;"></div>
</div>

<script language="javascript">
	grid = new dhtmlXGridObject('gridContent');
	grid.setImagePath("<?php echo base_url(); ?>/assets/codebase_grid/imgs/");
	grid.setHeader("ID,Tanggal Pembayaran, No. Pembayaran, NPWPD Perusahaan, Nama Perusahaan, Alamat Perusahaan, Jenis Usaha, Bulan Pembayaran, Jumlah Setoran");
	grid.setInitWidths("50,130,170,170,170,100,100,120,140");
