...
<script language="javascript">
	...
	function addRowList() {
		...
		var posisi = gridfrmData.getRowsNum(); 
		//gridPOS.uid(); 
		//gridPOS.addRow(id,'',0); 
		var row1= '';
		var row2= '';
...
<h2 style="margin:30px 5px 25px 30px;">Tarif Mineral Bukan Logam dan Batuan</h2>
<div class="oval_big2">
...
<script language="javascript">
	...
	gridfrmData.setHeader("Kode Rekening, Objek Pajak, Harga Pasar");
	gridfrmData.setInitWidths("90,250,120")
	gridfrmData.setColAlign("left,left,left")
	gridfrmData.setColTypes("ed,ed,ed");
	gridfrmData.enableMultiselect(true);
	gridfrmData.init();
	gridfrmData.setSkin("dhx_skyblue");
	gridfrmData.loadXML("<?php echo site_url(); ?>/master_setting/data_galianc");
	initDP();

	var dpps = "";
	function initDP() {
		dpps = new dataProcessor("<?php echo site_url(); ?>/master_setting/data_galianc");
