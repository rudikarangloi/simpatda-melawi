...
<h2 style="margin:30px 5px 25px 30px;">Volume Air Tanah</h2>
<div class="oval_big2">
...
<script language="javascript">
	...
	gridfrmData.setHeader("Volume, Nama Volume");
	...
	gridfrmData.loadXML("<?php echo site_url(); ?>/master_setting/data_volume");
	initDP();

	var dpps = "";
	function initDP() {
		dpps = new dataProcessor("<?php echo site_url(); ?>/master_setting/data_volume");
