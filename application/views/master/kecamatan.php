...
<h2 style="margin:30px 5px 25px 30px;">Master Data Kecamatan</h2>
<div class="oval_big2">
...
<script language="javascript">
	...
	gridfrmData.setHeader("ID, Kode Kecamatan, Nama Kecamatan");
	...
	gridfrmData.loadXML("<?php echo site_url(); ?>/master_setting/data_kecamatan");
	initDP();

	var dpps = "";
	function initDP() {
		dpps = new dataProcessor("<?php echo site_url(); ?>/master_setting/data_kecamatan");
