...
<h2 style="margin:30px 5px 25px 30px;">Master SPTPD</h2>
...
<script language="javascript">
	...
	gridfrmData.setHeader("ID, Kode SPTPD, Nama SPTPD");
	...
	gridfrmData.loadXML("<?php echo site_url(); ?>/master_setting/data_sptpd");
	initDP();

	var dpps = "";
	function initDP() {
		dpps = new dataProcessor("<?php echo site_url(); ?>/master_setting/data_sptpd");
