...
<div align="center">
	...
	<h2>Laporan Realisasi Penerimaan Retribusi</h2>
...
<script>
function pdf() {
	full = document.tetap.tahun.value;
	window.open('<?php echo site_url(); ?>/report_retribusi/cetak_realisasi?full='+full, '', 'height=700,width=1000,scrollbars=yes');
}
...
//	}
	...
	mygrid.clearAll();
	mygrid.loadXML("<?php echo site_url(); ?>/report_retribusi/data_realisasi/"+document.tetap.tahun.value,function() {
...
mygrid.setHeader("No. ,Nama Wajib Retribusi, Alamat, Tahun Lalu,Januari,Februari,Maret,April,Mei,Juni,Juli,Agustus,September,Oktober,November,Desember",//27
