		...
		$report .=
			'<table border="1">
				<tr style="font-family: Arial,Helvetica Neue,Helvetica,sans-serif; font-size:8px">
					...
					<td width="80" height="12" align="center"><strong>ALAMAT OP</strong></td>
...
$qr GROUP BY c.no_skpd  ORDER BY c.tgl ASC, b.status DESC 
)a
LEFT JOIN (SELECT author,tgl_bayar,setoran_wp,no_skpd FROM pembayaran)b
ON a.nomor=b.no_skpd ORDER BY a.tgl ASC, a.status DESC");
